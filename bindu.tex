...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
    \centerline{\textrm{\small{[\uproman{18}.\textsuperscript{\coro{\lowroman{1}-\lowroman{17}}} The Attribute of a Rājayogin's Body]}}}
    \label{rajabody}
    \bigskip
    \begin{prose}
      \noindent
...
%------------------------------
%Now the attribute of the person's body who is endowed with Rājayoga is taught.
%------------------------------
...
%------------------------------
\note[type=source, labelb=122, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 834): asya citte nānurāgo virāgo na bhaved iti | rājya prāpte 'pi no harṣo hānau duḥkhaṃ bhaven nahi | kvacid vastuni deśasya niḥsvane keṣu kutracit |}
aatha ca
...
\end{prose}
  ...
  \begin{translation}
    ...
    \bigskip
      \begin{tlate}
Now the attribute of the body of the person who is in the state of Rājayoga is taught. Abundance arises at all times. No distance exists on earth. He dwells on earth having pervaded [it]. Birth and death both do not exist.\textsuperscript{\coro{[\lowroman{5}]}} Happiness does not exist. Suffering does not exist. Impediment does not exist. Habit does not exist. Place does not exist.\textsuperscript{\coro{[\lowroman{10}]}} The manifestation of a permanent perception of the connection with god arises within the mind of the accomplished one. Moreover, he is shining - not cold, hot, white [and] or yellow. Neither is there caste of him nor does he have any attribute. Furthermore, he is without parts, immaculate and uncharacterized. His desire etc. does not arise in [situations of] lust [and] is not located within the duality of the result.\textsuperscript{\coro{[\lowroman{15}]}} He attains expanded enjoyment. However, his mind does not suffer attachment in this very state.
\end{tlate}
  \end{translation}
\end{alignment}
