...
\subsubsection{Reconstruction of the archetypal colophon}
\label{archetypalcolo}

The colophons of the manuscripts fall into two groups corresponding to the \beta- and \gamma-groups identified in the stemmatic analysis (p.~\pageref{stemma}). A close examination of these colophons reveals a gradual progression of corruptions in the transmission from \beta to \gamma.

  \begin{figure}[!ht]
    \centering
    \includegraphics[width=1\linewidth,height=1\textheight,keepaspectratio]{pics/colosynop.png} % Passe die Breite nach Bedarf an
    \caption{Synoptic transcription of the manuscripts' colophons.}
     \phantomsection\label{fig:colosynop}
\end{figure}

At the same time, a widespread misconception comes to light: the spiritual title \textit{paramahaṃsa} turns out to be only a later attribution to Rāmacandra resulting from a corruption in the colophon—an error which, to complicate matters, already appears in one of the oldest dated manuscripts. Yet \getsiglum{V} is not a trustworthy witness: its readings diverge so markedly from the rest of the transmission, without contributing anything of value to the reconstruction of the text, that I was compelled to exclude it from the collation. The scribe introduced numerous redactional changes, consciously omitted sentences, and on almost every folio one encounters large numbers of (often unsuccessful) attempts to ``improve'' Rāmacandra’s admittedly less elegant Sanskrit. One such failed attempt is preserved in the colophon of \getsiglum{V}, which reads: \textit{iti paramahaṃsasaṃhitāyāṃ haṃsyāṃ śrīrāmacaṃdraviracitāyāṃ tattvayogavicāraḥ}~|| The feminine endings in this colophon create the impression that Rāmacandra’s text formed part of another, perhaps larger, work entitled \textit{Paramahaṃsasaṃhitā}—a title that does exist, though it bears no relation to Rāmacandra’s text. The readings of the colophons in the other manuscripts of the \beta-group reveal that this colophon is yet another failed attempt by the redactor to improve upon his exemplar. The other manuscripts of the \beta-group (for example, the second-oldest witness \getsiglum{N1}, perhaps the best representative of the \beta-group) present the colophon along the following lines: \textit{iti śrīparamarahasyāṃ śrīrāmacaṃdraviracitāyāṃ tatvayogabiṃdu samāptaḥ}~|| At first glance this colophon appears contradictory. On the one hand, the title of the text is clearly given as \emph{Tattvayogabindu}; on the other, the feminine endings evoke the constructions typical of chapter colophons, which use the locative to indicate the overarching work and the final nominatives to provide the name of the concluding chapter. Taking the other witnesses of the \beta-group into account, it becomes evident that all members of the \beta-group continue to transmit the same grammatical irregularities and preserve the feminine endings. At a superficial level, the colophons of the \gamma-group do not appear to be of much help in resolving these issues. They all read approximately like \getsiglum{U2}: \textit{iti śrī rāmacaṃdraparamahaṃsaviracitas tatvabiṃduyogasamāptaḥ}~|| One might therefore conclude that the manuscripts of the \gamma-group are preferable, since their colophons are almost grammatically correct. However, as I demonstrated in the introduction (see p.~\pageref{titlediscussion}), we may safely assume that the original title was \emph{Tattvayogabindu} and not \textit{Tattvabinduyoga}. Moreover, when reflecting on the discrepancies between the readings of the two manuscript groups and taking into account the stemmatic conclusions—particularly the fact that the \beta-group preserves a version that on average must be closer to the original text than that of the \gamma-group—it becomes apparent that the colophons of the \beta-group are likely the result of redactional intervention. They represent, in other words, an attempt to emend an already corrupt colophon (presumably in a form similar to the colophons of the \beta-group).

This emerges, first, in the alteration of the title from the original \emph{Tattvayogabindu} to \emph{Tattvabinduyoga} in the \gamma-group; secondly, in the change from the \beta-reading \textit{paramarahasya} to \textit{paramahaṃsa}; and thirdly, in what appears to be a concomitant disregard for the feminine endings of the hyparchetype of the \beta-group, on the basis of which the redactional changes in the \beta-transmission appear to have been undertaken.

Any remaining doubts the reader may entertain regarding the plausibility of these hypothetical reconstructions can be dispelled by an important observation. The final section of the \emph{Tattvayogabindu}, namely \uproman{59}, which constitutes the undisputed culmination of the work, opens with the phrase \textit{idaṃ yogaśāstra\textbf{rahasyam} samagraśāstramadhye}, after which the ideal form of yoga intended for Rāmacandra’s audience is introduced. This makes it safe to assume that the occurrence of the forms of \textit{°rahasya} in the final colophon ultimately originates here. I consider it probable that an originally section-concluding colophon once preceded the work-concluding colophon. This provides the crucial clue to how the corrupt forms of the \beta- and \gamma-colophons arose:

The most likely archetypal colophon, \textit{iti śrīparamarahasyam} | \textit{iti śrīrāmacandravirācito 'yaṃ tattvayogabinduḥ samāptaḥ}~||, was corrupted through simple and typical scribal errors: the omission of \textit{iti} and the introduction of a feminine locative ending through a minor inaccuracy (°\textit{virācito 'yaṃ} → °\textit{viracitāyām}), followed by what was likely an automatic adjustment of °\textit{rahasyam} to °\textit{rahasyām}. This produced the reading \textit{iti śrīparamarahasyāṃ śrīrāmacaṃdraviracitāyāṃ tatvayogabiṃdu samāptaḥ}~||, from which the subsequent corruptions took their course. Later witnesses of the \beta-group, such as \getsiglum{D} and \getsiglum{U1}, copied the colophon from their exemplars, introducing further errors so that \textit{śrīparamarahasyāṃ} becomes \textit{śrīpāramahaṃsyāṃ}. Due to the loss of the feminine referent and the aforementioned copying error, scribes of the \gamma-group were led to a consequential emendation. From the intermediate stage \textit{iti śrīpāramahaṃsyāṃ śrīrāmacaṃdraviracitāyāṃ}, a scribe apparently felt compelled to introduce a plausible correction and altered the reading of his exemplar to \textit{iti śrīrāmacaṃdraparamahaṃsaviracitas}. Thus, Rāmacandra was erroneously ascribed the spiritual title of a \textit{paramahaṃsa} and consequently presumed to have undergone initiation into the Daśanāmī Saṃnyāsī order. See \citeauthor[2006: 42–45]{clark2006} for a discussion of the term \textit{paramahaṃsa} in the Daśanāmī Saṃnyāsī order.\footnote{I wish to thank Dr.~Jason Birch for sharing his thoughts regarding the reconstruction of the colophon, which provided the decisive impetus for arriving at a satisfactory solution.} Thus, even though looking at these somewhat confusing colophone transmissions, one might expect one \textit{iti} to mark the end of a chapter and the second to close the work as a whole. Yet one has to bear in mind that the text offers no clear system of chapters; instead, it is divided into numerous sections introduced by \textit{idānīṃ} or, more rarely, \textit{atha} and similar markers. These sections—aside from this single exception—never conclude with a ecolophon. It is therefore unlikely that the \textit{iti}s before the final colophon should be interpreted as a chapter colophon. Rather, I propose understanding it as an emphatic concluding formula that marks the climactic end of the text.
