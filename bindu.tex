...
\app{\lem[wit={E,P}, alt={prāṇavāyur}]{prāṇavāyu\skp{r-hṛ}}
  ...
  \rdg[wit={B,L}]{\om}}
\app{\lem[type=emendation, resp=egoscr, alt={ucchvāsapraśvāsaṃ}]{ucchvāsapraśvā:\\saṃ}
...
\app{\lem[wit={U2}, alt={śokam āpnoti vikṛtaḥ}]{śokam-āpnoti vikṛtaḥ}
...
\begin{tlate}[p26_01]
  \noindent
  Now, ten vital winds are situated within the body. Their functions are taught. The Prāṇa vital wind is located within the heart and causes inhalation and exhalation. There is a desire for food and drink. At the centre of the anus, the Apāna vital wind exists. He causes contraction and checking. At the centre of the navel, the Samāna vital wind exists. He causes to absorb [substances from]\footnote{The verbal form \textit{śoṣayati} (causative third person singular indicative present of √śuṣ) means ``causes to dry up'' or ``causes to disappear''. In this context, however, a better idiomatic translation would be ``causes to absorb'', since the Samāna vital wind absorbs the eaten substances in the body and distributes it everywhere, cf. \citetitle{yajnavalkya} 4.55-57 (Ed. p. 40) and 4.69ab (Ed. p. 42).}  all the channels. In this way, the channels are caused to be nourished, appetite is caused to be generated, and the fire [of digestion] is caused to be kindled. Within the throat, the Udāna vital wind is situated. This wind swallows food, [and] it drinks water. The Vyāna vital wind exists in the entire body.\footnote{I have conjectured \textit{nāgavāyu} to \textit{vyānavāyu} based on the description provided in YSv (PT), as the latter term generally corresponds to the provided function of this vitalwind. Some witnesses, namely \getsiglum{B}, \getsiglum{E}, \getsiglum{L}, \getsiglum{P} and \getsiglum{U2} contain a nonsensical fragment, ``\textit{śokam āpnoti vikṛtaḥ}'', right after the description of the \textit{vāyu}. This fragment is likely a remnant of the original description of \textit{nāgavāyu} that was lost during transmission.} Through the vital wind, the body is caused to move. \textbf{\large{\sic{\ldots}}}\footnote{In the YSv (PT pp. 838-839), the order of the ten vital winds is as follows: Prāṇa, Apāna, Samāna, Udāna, Vyāna, Kūrma, Nāga, Kṛkāra, Devadatta, Dhanañjaya. In the SSP 1.67 (Ed. pp. 23-24): Prāṇa, Apāna, Samāna, Vyāna, Udāna, Nāga, Kūrma, Kṛkāra, Devadatta, Dhanañjaya. In both texts, which are the probable sources for Rāmacandra, the Vyāna vital wind appears to be within the group of the first five major vital winds. This group of five winds is undoubtedly common across yogic literature, cf. \citeauthor[2017: 187-198]{rootsofyoga2017}. The emergence of Nāga instead of Vyāna in the witnesses indicates a corruption of the transmission. The description of the function of the vital wind in this passage makes it likely that the term Vyāna was dropped and replaced with Nāga, and in turn, the description of the function of Nāga was lost. The odd and nonsensical phrase \textit{śokam āpnoti vikṛtaḥ} might be a remnant of this lost description of Nāga. YSv (PT pp. 838-839) reads: \textit{udgāre nāga ākhyātaḥ ūrddhavāyuḥ pracālane} | `When belching, it is called the Nāga vital wind that initiates the forward movement' and SSP 1.67 (Ed. pp. 23-24) reads: \textit{nāgavāyuḥ sarvāṅgavyāpakaḥ mocakaś cālakaś ca}, `The Nāga vital wind pervades all limbs of the body and is releasing and moving.' Based on these sources' readings, the passage's reconstruction must remain unsolved.} The Kūrma vital wind exists within the eyes. It causes [the] opening and closing [of the eyes].
  \flushpage 
    \end{tlate}
  \end{translation}
\end{alignment}
...
\end{prose}
  ...
  \begin{translation}
    \begin{tlate}[p26_02]
\noindent
From the Kṛkala vital wind gagging arises. From the Devadatta vital wind jawning arises. From the Dhanaṃjaya vital wind speech arises.
\end{tlate}
\ekddiv{
...
\app{\lem[wit={B,E,L,U2},alt={tattvakāśaḥ}]{tattvakāśaḥ}
...
\rdg[wit={E}]{\om}} 
\app{\lem[wit={ceteri}, alt={aujvalyaṃ}]{aujva:\\lyaṃ}
  \rdg[wit={L}]{ujvalaṃ}
  \rdg[wit={E}]{\om}} 
\app{\lem[wit={ceteri}]{bhavati}
  \rdg[wit={B,L}]{bhavatī}
...
\end{prose}
 ...
 The foci of them are taught: Space, beyond space, great space, space of reality, the space of the sun. The focus onto the pure and formless space (\textit{akāśa}) shall be done internally as well as externally. Therafter, the focus oto beyond-space (\textit{parākāśa}) which is equal to dense darkness\footnote{Instead of extreme brightness as in the \citetitle{ssplonavla} (Ed. p. 29) and \citetitle{advaya} (Ed. p. 5), Rāmacandra has chosen to promote dense darkness in his \textit{parākāśa}-visualization.} shall be done internally and externally. Then, the focus noto the great space (\textit{mahākāśa}) which is the plethora of the burning fire of the time of dissolution shall be done internally and externally. Then, when internally and externally the brightness of millions of blazing lights arises, he shall execute the focus onto the reality-space (\textit{tattvakāśa}) which is as such.
 \flushpage 
\end{tlate}
  \end{translation}
\end{alignment}
...
\end{tlg}
  ...
  \begin{translation}
    \begin{tlate}[p28_02]
      \noindent
      After that, the focus of the sun-space (\textit{sūryakāśa}), which is associated with the sun disc's appearance of light, shall be done internally and externally. From the execution of these foci, contact with diseases does not arise within the body. Thus wrinkles and grey hair, sin or merit do not arise.
    \end{tlate}
    \begin{tlate}[28_1]
