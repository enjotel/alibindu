...
In Sektion \uproman{44} findet sich die zweite, und diesmal eindeutige Erwähnung von Siddhayoga inkl. einer Beschreibung Eigenschafen die einen Siddhayogin ausmachen. Diese Passage basiert diesmal nicht auf den Ausführungen der \textit{Yogasvarodaya}, sondern meisten der hier wiedergegebenen Verse sind aus der \textit{Siddhasiddhāntapaddhati} mit deutlichen redaktionellen Änderungen übernommen. Einige Verse dieser Passgae stammen wahrscheinlich aus Rāmacandras eigener Hand. Die gesamte Sektion dreht sich um die Charakteristik einer Avadhūta-Person (\textit{avadhūtapuruṣa}).\footnote{Eine rezente Diskussion der rezeptionsgeschichtlichen Entwicklung des Begriffes \textit{avadhūta} findet sich bei \fullcite{pudi2023}.} In den letzten drei Versen dieser Passage des Textes wird der Avadhūta mit einem Siddhayogin, im Sinne eines ``Yogin, der den Yoga vollendet hat'' gleichgesetzt. Ein Siddhayogin wird man jedoch mittels Siddhayoga:
...
Darüber hinaus lassen sich keine weiteren Aussagen treffen, die ein Siddhayoga weiter spezifizieren könnten. Anhand dieser wenigen Aussagen, lässt sich ableiten, dass Siddhayoga aus einer Methode der Reduktion der \textit{vāsanā}s bestehen dürfte, sowie eine spezifische Form der Philosophie, vermutlich die Philosophie der Doktrin der Siddhas (\textit{siddhasiddhānta}) einstudiert wird. Diese scheint hier universalistischen Charakter vermitteln zu wollen, heißt es doch in \uproman{44}.5, dass der Avadhūta sich am Ort des universellen Geistes sich befindet (\textit{nirākārapade sthitaḥ}) und alle philosophischen Ansichten in seiner eigenen essenziellen Natur offenbar werden (\textit{sarveṣāṃ darśanānāṃ ca svasvarūpaṃ prakāśate}). 
