...
\begin{longtable}{p{0.08\textwidth} p{0.4\textwidth} p{0.52\textwidth}}
    ...
    \uproman{42} & \textit{rājayogaśarīre cihnāni} & Characteristics of rājayogic body \\
...
\item[\textbf{Remarks:}] For the time being, this is the oldest dated surviving textual witness. After section \uproman{34}, there is a \textit{lacuna} until section \uproman{48}, approximately 23.50\% of the entire text is missing. 
...
\item[\textbf{Title:}] \emph{Tattvayogabindu} (The title folio reads: \textit{srī rājayogabindu prārambhaḥ}. The library card reads \textit{Rājayogatattvabindu}.)
...
Regrettably, the official commencement of this dissertation project (15 March 2021) coincided with the numerous lockdowns and travel restrictions imposed due to the COVID-19 pandemic. Consequently, during the phase of the dissertation in which additional manuscripts could have been collected, I was confined to my desk at home. The brief windows of opportunity for travel were further obstructed by pandemic-related familial complications. I have been able to identify the following manuscripts in catalogues, but unfortunately, I have not been able to consult them for this work.

\begin{description}
  
\item \nocite{newcataloguscatalogorum8} \nocite{newcataloguscatalogorum23} \citeauthor{hall1859} (1859: 14) reports a manuscript \uproman{25} called ``Tattva-bindu-yoga''. The entry says, ``Defining the divisions of Yoga. By Ramachandra Paramahansa. Leaves 18, \textit{śloka}s 440. F.E.H.''. The amount of \textit{śloka}s must be an approximation of the amount of text and not the actual number of verses since the text mixes prose and verse but is mainly written in prose. The abbreviation ``F. E. H.'' indicates that this manuscript personally belonged to Fitzedward \citeauthor{hall1859}. The New Catalogus Catalogorum (NCC) (Vol. 8: 54) revealed: ``Tattvabindu(Yoga) -by Rāmacandra Paramaham3sa. Ben. 66. IM. 5441 (inc.). Hall p. 14.''. The abbreviation ``IM'' indicates that the manuscript of \citeauthor{hall1859} should be deposited at the Royal Asiatic Society of Bengal (RASB). NCC (Vol. 23: 259) lists two manuscripts at the RASB: VIII. B. 6605. 6606. One of them should be the \citeauthor{hall1859} manuscript. Since I could not travel due to the pandemic, I tried to contact them several times via email and phone, unfortunately, without success. Of course, these manuscripts should contain important information and, ideally, should have been consulted. The good news is that judging by the title of the catalogue entry, this manuscript would belong to the systematically inferior \beta-group of the text and, thus, should play a secondary role in critically establishing the text.\footnote{See the stemmatic analysis on p. \pageref{stemma}.}

\item Collection: Nagpur University Library (NUL). Title: Tattvabindūyogaḥ. Author: Rāmacandra Paramahaṃsa. Material: Paper. Script: Devanāgarī. Ms. No.: 5760. Since I could not travel due to the pandemic, I tried to contact them several times via email and phone, unfortunately, without success. 

\item Collection: Sanskrit Vidyāpeetham near Yamuna Kinare, Etawah (U.P). Title: \textit{Tattvabindūyogaḥ}. Author: Rāmacandraḥ. Script: Devanāgarī. Condition: incomplete. Ms. No: ESV 7 (P20), cf. \citetitle{kaivalyadamanuscripts2005} of the Kaivalyadhama S.M.Y.M. Samiti (2005: 102-103). Since I could not travel due to the pandemic, I tried to contact them several times via email and phone, unfortunately, without success.

\item NCC (Vol. 23: 259) reports a manuscript in ``Baroda II. 10558''. This is \citetitle{baroda1950} (1950: 1238) reports it under the title \textit{Rājayogaprakāraḥ}.

\item Ānandāśrama Pune 2872. !!!!!!!
\item Darbhanga Raj 2146 (inc.) !!!!!!!!

  ujjval aus pune prof calcutta
  
  
\item CPB. Ms. No.: 4579-80. \citetitle{nagpur1926}(1926:408). Title ``Rājayoga''. Author: Rāmacandra Paramahaṃsa. Subject: Yoga. Owner. (4579) Nārāyaṃ Purānī of Hardā (Hoshangābād district). (4580) Viśvambharnāth of Ratanpur (Bilāspur district).  
\item Cs. III. 65. \citetitle{calcutta1900} 
\item IM. 5441 (inc.).
%\item Lonavla 152 (3 mss.; inc.). \item 155 (2 mss.; inc.). 375. 494 (2 mss.). 501 (2 mss.; 1 inc.).
\item Lucknow Skt. Parishad p. 224 (inc.).

SB. New DC. VII. 30019. ii. 93735. Ujjain I. p. 68. Ujjain Latest Additions 413. VVRI. I. p. 197.
|23|259|15|469|
...
\subsection{Discussion of the title}

\citetitle{kaivalyadamanuscripts2005} entries for Yogatattva etc. auf 230 - 233!
NCC Titel mit Yogatattva 
...
\footnote{Stemmatic analysis} 
\label{stemma}
\subsection{Conventions in the Critical Apparatus}
...
\subsection{The original title of the work}
...
The \emph{Yogasiddhāntacandrikā} is an important commentary on Patañjali's \emph{Yogasūtra}. Nārāyaṇatīrtha was a Brāhmaṇa, a devotee of Kṛṣṇa, a \textit{saṃnyāsa}, a renowned intellectual\footnote{Later authors like Brahmānanda considered Nārāyaṇatīrtha an authority in the field of yoga, as evidenced by his citation in the \citetitle{jyotsna} (Ed. p. 6).} and a prolific author\footnote{Nārāyaṇatīrtha composed several commentaries on the \emph{Yogsūtra} and other works in different literary genres. See \citeauthor{penna2004} 2004: 20-21).} Studies suggest that Nārāyaṇatīrtha flourished between 1600 and 1699.\footnote{Cf. \citeauthor{endo1993} 1993: 56.} Nārāyaṇatīrtha spent a considerable amount of time in Benares, though the exact period of his stay is unclear.\footnote{See especially \citeauthor{penna2004} (2004: 24). A comprehensive study on the life and works of Nārāyaṇatīrtha can be found in Endo \citeauthor{endo1993}'s \citetitle{endo1993} (1993). All excerpts of the \emph{Yogasiddhāntacandrikā} used in this dissertation are based on the following edition: \fullcite{yogacandrika}.}
...
Sant Sundardās (1596–1689) was a prominent 17th-century poet and scholar who, as a follower of the Dādūpanth, a religious group named after its founder Dādū, was deeply rooted in the Vaiṣṇava bhakti tradition.\footnote{For a comprehensive account of Dādū and the Dādūpanth (1544–1603), see \citeauthor{horstmann2023shrine} (2023: 71–77).} Born in the Būsar line of the Khandelval merchant caste (\textit{Vaiśya}), Sundardās met Dādū at a young age, probably shortly before 1600, and became his disciple.\footnote{Cf. \citeauthor{horstmann2023shrine} 2023: 86}.
...
After completing his education, Sundardās moved to Fatehpur in Rajasthan. He was known as a Sant poet and wrote numerous works\footnote{A selection of Sundardās' works has been translated by \citeauthor{horstmann2023shrine} in her book \citetitle{horstmann2023shrine} (2023: 151-182)}, and his scholarly activities extended to various disciplines.
...
Nārāyaṇatīrtha places his discussion of Layayoga\footnote{For an earlier discussion see \citeauthor{penna2004} 2004: 85-89.} in the context of his commentary of \textit{sūtra} 1.41:\footnote{\textit{Yogasiddhāntacandrikā} Ed. p. 64.} 
...
(\textit{arcā}).\footnote{\textit{Śivayogapradīpikā} 1.15: \textit{jñānaṃ śivamayaṃ bhaktiḥ śaivī dhyānaṃ śivātmakam} | \textit{śaivavrataṃ śivārceti śivayogo hi pañcadhā} || 15 || Translation by \citeauthor{powell2023} 2023: 315.} 
  \end{quote}
...
That is the core message of the secret of Yoga in all scriptures. It recalls the \textit{rājaguhyam} of the Mokṣopaya, a teaching through which rulers could attain a state free from suffering.\footnote{Cf. \emph{Mokṣopaya} 2.11.10-17.} These words conclude Rāmacandra's \emph{Yogatattvabindu}. Sahajayoga is referred to as \textit{cakravartī} (``Universal Ruler''). That indicates that while Sahajayoga still belongs to the category of Rājayoga, at this point, Rājayoga must primarily be understood as ``Yoga for Kings,'' with Sahajayoga being the undisputed supreme ruler within this category. For a king who rules and enjoys the amenities of this position, this is the aspired state, the ultimate. As a \textit{kṣatriya}, he can maintain the soteriological state of salvation through Sahajayoga and continue fulfilling his caste duties without continuous practice. The duties of a ruler sometimes involve ``cruel'' actions, such as enforcing laws, possibly through war. Additionally, Sahajayoga enables the king, despite being an ``enjoyer of the earth,'' to achieve soteriological completion without the deprivations typical for ascetics.\footnote{See also \citeauthor{hanneder2006} 2006: 121.} The term \textit{sahaja°} in this context thus primarily means natural but in the sense of ``preserving its original nature'' and ``not undergoing further change.''\footnote{Cf. \citetitle{petersburger7} 1858: 99.}
