...
The comparative analysis of Lakṣyoga within the four texts of the complex early modern Yoga taxonomies reveals some significant insights into this type of Yoga. While it is certain that the practice involving \textit{lakṣya}s emerged much earlier, the four texts of the complex early modern Yoga taxonomies, namely the \emph{Yogasvarodaya}, \emph{Yogatattvabindu} and the \emph{Sarvāṅgayogapradīpikā} are the first texts that teach Lakṣyayoga as a distinct category of Yoga. In comparison to earlier threefold models which consist of \textit{antarlakṣya}, \textit{bahirlakṣya} and \textit{madhya(ma)lakṣyaa}, the concept of five \textit{lakṣya}s appears only in the lost Yogasvarodaya and from there made its way into \emph{Prāṇatoṣinī}, \emph{Yogakarṇikā} and \emph{Yogatattvabindu}. Via the \emph{Yogatattvabindu}, it reached the \emph{Haṭhasaṃketacandrikā}. The other texts speaking of Lakṣyayoga as a distinct Yoga category are \emph{Sarvāṅgayogapradīpikā} and \emph{Yogasiddhāntacandrikā}. If one encounters the concept of three \textit{lakṣya}s in other texts like the \emph{Netratantra} with \emph{Netroddyota} (cf. 7.1), \emph{Śivayogapradīpikā} (cf. 4.36-50), \emph{Maṇḍalabrāhmaṇopaniṣat} (cf. 2.6-2.14) or \emph{Advayatārakopaniṣat} (Ed. pp. 3-5) etc. it is never declared as an own type of Yoga. Additionally, we have witnessed a conceptionally largely congruent perspective on Lakṣyayoga across the texts. Thus, Lakṣyayoga is a signature Yoga category of texts containing complex Yoga taxonomies. 
