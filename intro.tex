...
Although Dhyānayoga, as already mentioned at the beginning, is mentioned in both texts\footnote{The list of mentions of \textit{dhyāna} is based on the sections of the \textit{Yogatattvabindu}. The corresponding passages of the \textit{Yogasvarodaya} can be taken from the critical apparatus of the present edition of the text.} are not mentioned separately and thus explicitly, various \textit{dhyāna}s can be found throughout the text. The first mention of \textit{dhyāna} occurs in the context of the detailed description of a total of nine \textit{cakra}s in the sections \uproman{4}-\uproman{12}. Rāmacandra and the unknown author of the \textit{Yogasvarodaya} instruct \textit{dhyāna} on the respective \textit{cakra}, or a \textit{mūrti} located in the respective \textit{cakra}. The scribe-author of manuscript \getsiglum{U2} even adds more precise instructions on the duration of the meditations on the respective \textit{cakra}s. However, as we discover in section \uproman{3}, this meditation practice is attributed to Siddhakuṇḍalinīyoga or Mantrayoga and not to Dhyānayoga. We also encounter the term \textit{dhyāna} in the description of \textit{adholakṣya} in section \uproman{15}, in the second subtype of Haṭhayoga in section \uproman{20}, in the description of \textit{bāhylākṣya} in section \uproman{23}, as well as within \textit{antaralakṣya} in section \uproman{24}. Another mention can be detected within the list and the eight limbs of \textit{aṣṭāṅgayoga} in section \uproman{31}. Here, we learn that \textit{dhyāna} is not discussed further in this context, as this has happened many times before.\footnote{\textit{dhyānaṃ ca bahutaraṃ prāg uktaṃ tenātra cocyate} |} In \uproman{32}-\uproman{41} the identity of the external universe with the body is taught. Various contents, such as the fourteen worlds, mountains and rivers, etc., are located in the body, similar to the \textit{Yogasiddhāntacandrikā}. However, Rāmacandra does not specify a concrete reason for listing these physical equivalents of the external universe in the body. The same is true for the parallel passages of \textit{Yogasvarodaya} and \textit{Siddhasiddhāntapaddhati}. In section \uproman{48}, in the context of the divisions of the lotus in the heart, meditation on this heart lotus is also instructed, which is supposed to lead to the illumination of the self and enhance vitality. Therefore, I conclude that although Dhyānayoga is not provided with its own section in either text, it is at least implicitly present in both texts and the generic term of meditation (\textit{dhyāna}) is nevertheless a central theme. 


\section{8. Mantrayoga}
\label{dhyānayogaintro}

Mantrayoga nimmt in der Taxonomie des \textit{Yogatattvabindu} die achte Position ein, die sechste Position im \textit{Yogasvarodaya}, die fünfte Position in der \textit{Yogasiddhāntacandrikā} und steht an zweiter Stelle der zwölf Yogas der \textit{sarvāṅgayogapradīpikā}. Mantrayoga wird von Sundardās dem Bhaktiyoga zugerodnet.

\subsection{Mantrayoga in the \textit{Yogatattvabindu} and \textit{Yogasvarodaya}}

Abgesehen von der Erwähnung von Mantrayoga in den ersten Versen der Zitate des \textit{Yogasvarodaya} in der \textit{Prāṇatoṣinī}\footnote{Cf. \emph{Prāṇatoṣinī} Ed. p. 831 quoted with reference \textit{yogasvarodaye}.} beinhalten die uns erhaltenen und vorliegenden Zitate weder eine Beschreibung von Mantrayoga noch die Beschreibung einer Yogapraxie die \textit{mantra}s beinhaltet. Im \textit{Yogatattvabindu} hingegen, fällt der Begriff Mantrayoga in Sektion \uproman{3} erneut:
...
Hierauf folgt eine Erklärung der drei primären Kanäle des yogischen Körpers: Iḍā, Piṅgalā und Suṣumnā. Die Sektion schließt mit der Erklärung, dass die [übende] Person allwissend wird, sobald das Wissen über den zentralen Kanal hervorgebracht wurde. In den darauffolgenden Sektionen \uproman{4}-\uproman{12} wird dann ein System bestehend aus insgesamt neun \textit{cakra}s beschrieben.

Aus textkritischer Perspektive ist diese Passage auffällig und problematisch. Ein Grund dafür ist, dass Rāmancandra sich in der ersten Hälfte seines Textes und auch weitestgehend in der zweiten Hälfte strukturell und inhaltlich sehr an seiner Vorlage, der \textit{Yogasvarodaya} orientiert. Das \textit{Yogasvarodaya} nennt hier jedoch \textit{jñānayoga} anstatt \textit{siddhakuṇḍalinīyogaḥ mantrayogaḥ} liest. Inhaltlich ähnelt der Rest des Abschnittes wie gewohnt sehr stark der \textit{Yogasvarodaya}. Die Handschriften bieten für die auffällige Passage allerdings keine Alternativen, sodass bis auf Weiteres der Text akzeptiert werden muss. Ein weiterer Grund ist die seltsam anmutende Satzkonstruktion, welche jedoch, kennt man den Rest des Textes, schlussendlich doch nicht überrascht und daher akzeptiert werden kann. Der Leser hätte sich hier im Anschluss zumindest ein \textit{ca} (``und'') gewünscht. Allein Handschrift \getsiglum{L} lässt den Begriff \textit{mantrayogaḥ} aus, bewahrt aber die nachfolgenden Dualformen, sodass dies auch keine Lösung ist.    

Das erstgenannte \textit{cakra} namens \textit{mūlacakra} wird mit folgender Einleitung versehen:
...
\begin{quote}
  ...
  Anhand dieser Beschreibung kann nur davon ausgegangen werden, dass die Sektionen \uproman{4}-\uproman{12}, welche die neun \textit{cakra}s beschreiben, von Rāmacandra dem Siddhakuṇḍalinīyoga und Mantrayoga zugeordnet werden. Fast alle Handschriften, abgesehen von Handschrift \getsiglum{U2}, lassen jedoch in diesem Kontext keinen Rückschluss auf eine Praxis zu, die als Mantrayoga bezeichnet werden könnte zu.

  Die Handschrift \getsiglum{U2} enthält allerdings ausführliche zusätzliche Passagen, welche das Problem lösen und eine Praxis, die als Mantrayoga bezeichnet werden kann, ergänzt. Für jedes \textit{cakra} instruieren alle Handschriften \textit{dhyāna} auf das jeweile \textit{cakra}. Handschrift \getsiglum{U2}, enthält neben diversen zusätzlichen Details, immer jeweils eine Angabe für die Dauer der Meditation, die unter anderem\footnote{Die \textit{cakra}s erhalten zusätzlich, die gleiche Zeitangabe gemessen in \textit{ghaṭi}s, \textit{pala}s und \textit{akṣara}s. Siehe \citeauthor{birch2013} 2013: 265, n. 46.} in \textit{ajapājapa}s (``Die Rezitationen des Nichtrezitierten.'') gemessen wird. Schließlich wird dann anhand des zusätzlichen Materials zu Sektion \uproman{11} von Handschrift \getsiglum{U2} klar, dass hiermit das sog. \textit{ajapā mantra} bzw. \textit{haṃsa mantra}\footnote{Wahrscheinlich erstmals in der Yogaliteratur gelehrt in \citetitle{vivekamartandaolda} 28-30.} gemeint sein muss:
...
Das \textit{ajapā mantra} (``unmuttered Mantra'') besteht aus dem beiden Silben \textit{haṃ} und \textit{saḥ} entsprechend der phonologischen Assoziation mit dem Klang der Ein- und Ausatmung. Weil alle Lebewesen ein- und ausatmen, heißt es, rezitieren die das \textit{ajapā mantra} ununterbrochen Tag und Nacht. Gleichzeitig ist \textit{haṃsaḥ} eine berühmte und uralte Metapher für die Seele, welche druch das Rad des Brahman oder Saṃsāra wandert.\footnote{Siehe \citetitle{hauschild1927} 1.6 und 3.18.} 

Manchmal wird dieses Mantra auch \textit{ajapā gāyatrī} genannt.\footnote{Das \textit{ajapā} als eine yogische Aneignung des vedischen \textit{gāyatrīmantra}s gesehen werden (\citetitle{rootsofyoga2017} 2017, 134).}  

Handschrift \getsiglum{U2} erklärt, dass die tägliche Gesamtzahl aller stillen Rezitatonen des \textit{haṃsa mantra}s 21600 beträgt\footnote{Die Anzahl der Gesamtatemzüge basiert auf der Annahme einer durschnittlichen Atemzugdauer von vier Sekunden. Jeder Tag hat 86400 Sekunden. Teilt man diese Gesamtzahl durch vier erhält man die besagten 21600 Atemzüge des \textit{ajapā mantra}. \citeauthor{birch2013} (2013, 265, n. 46) argumentiert, dass diese Annahme aus \citetitle{svacchandatantra} 7.54-55 stammt. Neben der Handschrit \getsiglum{U2} des \textit{Yogatattvabindu} ist dieses yogische Axiom in der Sanskrit Yogaliteratur weit verbreitet. Siehe z.B. \citeauthor{amaraughaprabodha} 58, Hemacandra’s \citetitle{hemacandras} 5.232, \textit{Vivekamārtaṇḍa} 46, \textit{Gheraṇḍasaṃhitā} 5.79, \textit{Dhyānabindūpaniṣad} 62ab-63ab oder \citetitle{jogpradipyaka} 913.} Die Assoziation des Begriffes Mantrayoga mit der Praxis des \textit{haṃsa mantra} ist in der Sanskrit Yogaliteratur weit verbreitet.\footnote{Siehe z.B. \citetitle{yogabija} 147; \citetitle{shivayogapradipika} 2.26-27 and 2.29-32 (\citeauthor{shivayogapradipikax} (2023: 205), explains that here, however ``mantra is reframed and interiorized within a \textit{prāṇāyāma} environment, specifically in the form of the \textit{ajapā}, the “unuttered” mantra''); \emph{yogacintamani} (Ed. p. 12); \citetitle{hathatattvakaumudi} 55.28; and \citetitle{yogasikhopanisad} 132.}

Aus textkritischer Perspektive gibt es hinsichtlich der Authentizität der besprochenen Passagen ambivalente Evidenz. Alle Handschriften erwähnen Mantrayoga in der oben angeführten Passage. Wir müssen demnach davon ausgehen, dass Mantrayoga hier ursprünglich und vielleicht sogar bewusst von Rāmacandra genannt wurde, auch wenn, oder gerade weil, der die Quelltextvorlage hier anders liest. Stutzig muss einen der Fakt machen, dass nur die Handschrift \getsiglum{U2} explizit ein Mantrayoga lehrt. Zusätzliches Material findet sich in dieser Handschrift nur in den Sektionen \uproman{4}-\uproman{12}. Das wahrscheinlichste Szenario ist, dass der Schreiber der Handschrift \getsiglum{U2} diese Ergänzungen vorgenommen hat, um die fehlenden Ausführungen über Mantrayoga bereitzustellen.\footnote{Der in \getsiglum{U2} hergestellte Zusammenhang zwischen Siddhakuṇḍalinīyoga und Mantrayoga findet sich in ähnlicher Form in \citetitle{sarada} 25.37ab: `The \textit{kuṇḍalī} Śakti abides in the \textit{haṃsaḥ} [and] supports the [individual] Self.' (\textit{bibharti kuṇḍalī śaktir ātmānaṃ haṃsaṃ āśritā} |), see \citeauthor[2011: pp. 218, 228]{saradatilakafull}.} Handschrift \getsiglum{U2} gehört zu der \beta-Gruppe der Handschriften, welche in einem Großteils des Textes häufig schlechtere Lesarten bereithält als die \alpha-Gruppe mit der ältesten Handschrift \getsiglum{N1}. Dies lässt auch das andere Szenario zunächst weitaus unwahrscheinlicher erscheinen, nämlich, dass \getsiglum{U2} trotz der jüngeren Datierung einen ursprünglicheren Text überliefert als alle anderen Textzeugen. Allerdings weist die älteste Handschrift \getsiglum{N1} zumindest im letzten Drittel des Textes immense Lücken auf. Handschrift \getsiglum{U2} hingegen ist hier, zusammen mit einigen Kandidaten der \beta-Gruppe vollständig. Desweiteren konserviert nur Handschrift \getsiglum{U2} die definitiv korrekte Variante des Satzes \textit{bhuktimuktidā śivarūpiṇī suṣumṇānāḍī pravartate} | \textit{asyā jñānotpattau satyāṃ puruṣaḥ sarvajño bhavati} | in Sektion \uproman{3}.    
\end{document}
