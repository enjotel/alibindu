...
Nārāyaṇatīrtha verortet Mantrayoga, wie zuvor bereits Jñānayoga im Kontext von \textit{sūtra} 1.28. Dieses \textit{sūtra} und der dazugehörige Kommentar von Nārāyatīrtha wurde bereits im Kapitel über Jñānayoga in der \textit{Yogasiddhāntacandrikā}'' (p.\pageref{jnanayogaintrocandrika} et sqq.) diskutiert und muss daher an dieser Stelle nicht wiederholt werden.\footnote{For another discussion of Mantrayoga in the \textit{Yogasiddhāntacandrikā} see \citeauthor{penna2004} 2004, pp. 71-76.} Mantrayoga in der \textit{Yogasiddhāntacandrikā} ist \textit{japa} (``low-voice muttering'') von \textit{praṇava} (``heilige Silbe \textit{auṃ}''), welches auf zwei alternative Weisen ausgeführt werden kann, als Jñānayoga\footnote{Das Konzept von Jñānayoga in der \textit{Yogasiddhāntacandrikā} diskutiere ich auf p.\pageref{jnanayogaintrocandrika}.} oder Advaitayoga.\footnote{Das Konzept von Advaitayoga in der \textit{Yogasiddhāntacandrikā} diskutiere ich auf p.\pageref{advaitayogaintrocandrika}.}    
%\begin{quote}
...
Für Sundardās ist Mantrayoga die Rezitation des Namens Rāma, als Bezeichnung der höchsten Realität. 
