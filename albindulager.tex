...
\begin{edition}
 \ekddiv{type=ed}
 \centerline{\textrm{\small{[\uproman{1}.\textsuperscript{\coro{[\lowroman{1}-\lowroman{12}]}} Introduction]}}}
 \label{intro}
    \bigskip
    \begin{prose}
%--------------------------
...
\nolinenumbers    
\smallskip
\centerline{\textrm{\small{[\uproman{2}. Kriyāyoga]}}}
\label{kriyayoga}
\bigskip
\linenumbers
%--------------------------        
...
\tl{\note[type=source, labelb=5, lem=\textbf{Cee}]{PT\textsuperscript{ccn \cdot YSV} (Ed. p. 839): tatsāṅgācaraṇaṃ kurvan kriyāyogarato bhavet |}
  ...
  kurvan-kriyāyoga\skp{s-ta}\app{\lem[wit={P,U2}, alt={tato bhavet}]{\skm{s-t}ato bhavet}
    ...
    \rdg[wit={U1}]{ato va}}\dd{}\begin{otherlanguage}{english}\lowroman{2}\end{otherlanguage}\hskip-2pt\dd{}}
\end{tlg}
\vfill
\ekdpb*{}
\end{edition}
...
\noindent This is the result of Rājayoga\footnote{This statement seems unconnected to the definition of rājayoga that follows.}: Rājayoga is that by which long-term durability of the body arises
...
kriyāyogī nigadyate\dd{}\begin{otherlanguage}{english}\lowroman{3}\end{otherlanguage}\hskip-2pt\dd{}}
\end{tlg}
\begin{tlg}
%-----------------------
% \om                                                \B
...
%-----------------------
       \tl{kāma\app{\lem[wit={U1,U2}, alt={°krodhau}]{krodhau}
         ...
         \app{\lem[wit={ceteri}]{'śuciḥ}
           \rdg[wit={E,N2,U2}]{śuciḥ}}\dd{}\begin{otherlanguage}{english}\lowroman{4}\end{otherlanguage}\hskip-2pt\dd{}}    %%%AVAGRAHA
\end{tlg}
\begin{tlg}
%-----------------------
%  \om                                                           \B
...
%  -----------------------        
        \tl{
yasyai tāni \app{\lem[wit={ceteri}]{na}\rdg[wit={E}]{ca}} vidyante kriyāyogī sa ucyate\dd{}\begin{otherlanguage}{english}\lowroman{5}\end{otherlanguage}\hskip-2pt\dd{}}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
      \end{tlg}
      \bigskip
      \begin{prose}
%-----------------------
...
\ekddiv{type=trans}
\begin{tlate}
\paragraph{\lowroman{3}.} Patience, discrimination, equanimity, peace, modesty, desireless:\textsuperscript{\coro{[\lowroman{5}]}}the one who is endowed with these means is said to be a Kriyāyogī. 
\paragraph{\lowroman{4}.} Envy, selfishness, cheating, violence, desire and intoxication, pride, lust, anger, fear, laziness, greed, error and impurity. 
\paragraph{\lowroman{5}.} Attachment and aversion, indignation and idleness, impatience and dizzyness: Whoever does not experience these is called a Kriyāyogī.\textsuperscript{\coro{[\lowroman{15}]}}
\\\\
...
\note[type=testium, labelb=27a, lem={\textbf{Ci}}]{\textit{Yogasaṃgraha} IGNCA 30020 folio 1r. ll. 5-6: bhuktimuktipradā suṣumnā nāḍī vartate | yasyāḥ jñāne purusaḥ sarvajño bhavati |}
  ...
  \rdg[wit={E,L}]{bhuktimuktipradā}}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{10}]}\end{otherlanguage}}
...
\app{\lem[wit={ceteri}]{sphurati}
  \rdg[wit={L}]{sphuraṃti}}/
      \extra{asya
        ...
        uparamānandā\dd{}
        ajapājapaśat\dd{} 600\dd{} ghaṭi 9 palāni 40\dd{}}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{10}]}\end{otherlanguage}}
      \vspace*{\fill}
    \end{prose}
    \ekdpb*{}
   \end{edition}
...
\begin{edition}
 \ekddiv{type=ed}
 \centerline{\textrm{\small{[\uproman{5}.\textsuperscript{\coro{\lowroman{1}-lowroman{5}}}Second Cakra]}}}
 \label{cakra2}
    \bigskip
    \begin{prose}
%-----------------------
...
}\skm{m-ā}yur-vardhate\dd{}\vspace*{\fill}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
\end{prose}
\end{edition}
\begin{translation}
  \ekddiv{type=trans}
...
\begin{translation}
  ...
  \begin{tlate}
    ...
    \begin{tlate}
    \bigskip
    \centerline{\textrm{\small{[\uproman{X}.\textsuperscript{\coro{\lowroman{1}-\lowroman{11}}} Seventh Cakra]}}}
    \label{cakra7trans}
    \bigskip
