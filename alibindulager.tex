...
%-------------------------- 
   \tl{\note[type=source, labelb=4, lem=\textbf{Cee}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 831): kriyāmuktimayo (\textit{kriyāmuktir ayaṃ} YK\textsuperscript{qcr \cdot YSV} 1.209  Ed. p. 17) yogaḥ sapiṇḍisiddhidāyakaḥ (\textit{sapiṇḍe} YK\textsuperscript{qcr \cdot YSV} 1.210 Ed. p. 17) | yatkāromīti saṅkalpaṃ kāryārambhe manaḥ sadā ||}
...
%--------------------------
\tl{\note[type=source, labelb=5, lem=\textbf{Cee}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): tatsāṅgācaraṇaṃ kurvan kriyāyogarato bhavet |}
...
%--------------------------
      \tl{\note[type=source, labelb=6, lem=\textbf{Cee}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 831): kṣamāvivekavairāgyaśāntisantoṣanispṛhāḥ | etan muktiyuto yo 'sau (\textit{muktiyutaś cāsau} YK\textsuperscript{qcr \cdot YSV} 1.211 Ed. p. 17) kriyāyogo nigadyate |}
...
%-----------------------
       \tl{\note[type=source, labelb=9, lem=\textbf{Ce}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 831): mātsaryaṃ mamatā māyā hiṃsā ca madagarvitā | kāmaḥ krodho bhayaṃ lajjā lobho mohas tathā 'śuciḥ (\textit{śuciḥ} YK\textsuperscript{qcr \cdot YSV} 1.212 Ed. p. 17) ||}
...
%-----------------------
        \tl{\note[type=source, labelb=10, lem=\textbf{Ce}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 831): rāgadveṣau ghṛṇālasyaśrāntidambhakṣamābhramāḥ (\textit{ghṛṇālasyaṃ bhrāntir dambho 'kṣamā bhramaḥ} YK\textsuperscript{qcr \cdot YSV} 1.213 Ed. p. 17) | yasyai tāni na vidyante kriyāyogī sa ucyate ||}
...
\app{\lem[wit={E,N1}]{siddhakuṇḍalinīyogaḥ}
 ...
 \app{\lem[wit={ceteri}]{mantrayogaḥ}
   \rdg[wit={L}]{\om}}
       \note[type=source, labelb=19, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 831): jñānayogaṃ pravakṣyāmi tajjñānī śivatāṃ vrajet | paṭhanāt smaraṇād vyānān maṇḍanāt brahmasādhakaḥ | tad bhedasyaikasandhānam aṣṭaiśvaryamayo bhavet | tritīrthaṃ yatra nāḍī ca tripuṇyaṃ parameśvari | \ldots eṣo 'sya viśvarūpasya rājayogo mato budhaiḥ | viśeṣaṃ kathayiṣyāmi śṛṇu caikamanāḥ sati |}
%-----------------------
% \om                         \B
...
\note[type=testium, labelb=20, lem={\textbf{Ci}}]{\textit{Yogasaṃgraha} IGNCA 30020 folio 1r. ll. 3-4: mūlakandasthāne ekā tejomayā mahānāḍī vartate |}
       ...
       \note[type=source, labelb=21, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 831-832): mūlakande sthale caikā nāḍī tejasvatī parā (\textit{tejasvitāparā} YK\textsuperscript{qcr \cdot YSV} 1.246 Ed. p. 20) |}
%-----------------------
% \om                                                            \B
...
vāmabhāge candrarūpā
        ...
        \app{\lem[wit={ceteri}]{vartate}
          ...
          \note[type=source, labelb=24x, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): gudorddhe (\textit{gudordhve} YK\textsuperscript{qcr \cdot YSV} 1.247 Ed. p. 20) sā tribhāgābhūdiḍā (\textit{tridhā bhūyādiḍāvāme} YK\textsuperscript{qcr \cdot YSV} 1.247 Ed. p. 20) nāma śaśiprabhā | śaktirūpā mahānāḍī dhyānāt sarvārthadāyinī | dakṣiṇe 'pi kulākhyeti (\textit{piṅgalākhyeti} YK\textsuperscript{qcr \cdot YSV} 1.248 Ed. p. 20) puṃrūpā sūryavigrahā |}
%-----------------------
% \om                                                \B
...
\note[type=source, labelb=26x, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): madhyabhāge suṣumnākhyā brahmaviṣṇuśivātmikā | śuddhacittena sā vijñā vidyutkoṭisamaprabhā | bhuktimuktipradā dhyānād aṇimādiguṇapradā|}
...
\begin{translation}
  \ekddiv{type=trans}
   ...
   \label{siddhayogatrans}
    \bigskip
    \begin{tlate}
\noindent Now, varieties of Rājayoga will be described. Which are these? One is Siddhakuṇḍalinīyoga [and one\footnote{The use of the term \textit{siddhakuṇḍalinīyoga} instead of \textit{siddhayoga} as listed initially is surprising. Furthermore, this type of Yoga, listed as the second-last item in the initial Yoga taxonomy, is introduced as the second type right after Kriyāyoga, which was the first item in both the initial list and the subsequent text. This raises further questions as the term \textit{kuṇḍaliṇī} is not mentioned at all in the subsequent description of this type of Yoga. The relation between "Siddhakuṇḍalinīyoga" and "Mantrayoga" appears mysterious since only the relatively late witness \getsiglum{U2} provides some description of a certain type of Mantrayoga. The additional passages of witness U\textsubscript{2}, highlighted in blue, instructs the "recitation of the non-recited" (\textit{ajapājapa}) of the \textit{haṃsaḥ} \textit{mantra}, also called "non-recitation" (\textit{ajapā}) Gāyatrī, during meditation for almost each (seven out of nine) \textit{cakra}. All witnesses except \getsiglum{L} (\getsiglum{L} omits the term \textit{mantrayoga}) preserve this reading, and the sentence that follows the term supports the reading of \textit{mantrayoga} by the usage of dual forms. The \textit{Yogatattvabindu} closely follows the structure and content of the \textit{Yogasvarodaya}, as quoted with reference in \textit{Prāṇatoṣiṇī} and \textit{Yogakarṇikā}. However, the Yoga introduced in \textit{Yogasvarodaya} at this point is \textit{jñānayoga} and neither \textit{siddhakuṇḍalinīyoga} nor \textit{mantrayoga} are mentioned. Since all manuscripts preserve the strange reading, but only the context of \getsiglum{U2} the terminology makes sense, it must be assumed that the additional passages of \getsiglum{U2} might have been original and the seemingly ``additional'' material could be ``original'' material and was lost in the early transmission of the text. A related text, the \citetitle{sarada} 25.37ab provides a possible explanation for the linking of the two types of Yoga: "The kuṇḍalī Śakti abides in the \textit{haṃsaḥ} [and] supports the [individual] Self" (bibharti kuṇḍalī śaktir ātmānaṃ haṃsaṃ āśritā |), see \citeauthor[2011: pp. 218, 228]{saradatilakafull}.}] is Mantrayoga. These two Rājayogas are described [in the following]. At the location of the root-bulb\footnote{The root-bulb or \textit{kanda} in yogic literature is usually located below the navel or near the perineum. For more details, see \pageref{antaralaksya}. Rāmacandra's concept of the Kanda is identical to the one found in \citetitle{vivekamartandaolda} 16 (ūrdhvaṃ meḍhrād adho nābheḥ kandayoniḥ khagāṇḍavat | tatra nāḍyaḥ samutpannāḥ sahasrāṇi dvisaptatiḥ ||) ``Above the penis and below the navel is the home of the Kanda, which is [formed] like the egg of a bird. There, the 72000 channels originate.''} exists one major vessel in the form of energy.\textsuperscript{\coro{[\lowroman{5}]}} This single vessel reaches to these openings which are \textit{iḍā}, \textit{piṅgalā} and \textit{suṣumnā}. On the left side is the \textit{iḍā}-channel, resembling the moon. On the right side exists the \textit{piṅgalā}-channel, resembling the sun. Within the middle path is a lotus pond being very subtle.\textsuperscript{\coro{[\lowroman{10}]}} [It is] made from a web of light [and it] shines like a thousand bolts of lightning. She \extra{emerges as the central channel assuming the form of benevolence (\textit{śiva}), [and]} is the bestower of enjoyment and liberation. While abiding in (\textit{satyāṃ}) her (\textit{asyāṃ}) knowledge arises. The person becomes all-knowing. \vspace*{\fill}
    \end{tlate}
    \ekdpb*{}
   \end{translation}
 \end{alignment}
...
\noindent 
      ...
      \note[type=source, labelb=29, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): suṣumnāntaḥ samāśritya navacakraṃ yathā śṛṇu | mūlādhāraṃ catuṣpatraṃ gudorddhe (\textit{gudordhve} YK\textsuperscript{qcr \cdot YSV} 1.250 Ed. p. 20) varttate mahat | tanmadhye svarṇapīṭhe tu trikoṇaṃ maṇḍalaṃ (\textit{trikoṇamaṇḍalaṃ} YK\textsuperscript{qcr \cdot YSV} 1.251 Ed. p. 20) param | tatra vahniśikhākārā mūrttiḥ sarvatra siddhidā | asyā dhyānaṃ manomadhye vinā pīṭhena (\textit{pāṭhena} YK\textsuperscript{qcr \cdot YSV} 1.252 Ed. p. 20) vāṅmayam | sarvaśāstrāṇi saṅkarṣaṃ (\textit{saṃkarṣa} YK\textsuperscript{qcr \cdot YSV} 1.252 Ed. p. 20) sadā sphurati yogavit |}
...
\note[type=source, labelb=36, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): liṅgamūle tu pīṭhābhaṃ (\textit{raktābhaṃ} YK\textsuperscript{qcr \cdot YSV} 1.253 Ed. p. 20) svādhiṣṭhānan tu ṣaḍdalam | tanmadhye bālasūryābhaṃ mahajjyotiḥ susiddhidam | dhyānāc ca varddhate āyuḥ kandarpasamatāṃ vrajet |}
\app{\lem[wit={ceteri}]{idānīṃ}
          \rdg[wit={N2}]{idānī}}
...
\begin{edition}
 ...
 \label{cakra3}
    ...
    \begin{prose}
      \noindent
      \note[type=source, labelb=40, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): tṛtīyaṃ nābhideśe tu digdalaṃ paramādbhutam | mahāmeghaprabhaṃ tat tu koṭividyutsamanvitam | kalpāntāgnisamaṃ (\textit{kalpānto 'gni°} YK\textsuperscript{qcr \cdot YSV} 1.255 Ed. p. 20) jyotis tanmadhye saṃsthitaṃ svayam | tasya (\textit{asya} YK\textsuperscript{qcr \cdot YSV} 1.256 Ed. p. 21) dhyānāc cirāyuḥ syād arogo (\textit{arogī} YK\textsuperscript{qcr \cdot YSV} 1.256 Ed. p. 21) jagatāṃ varaḥ (\textit{jagatāmvaraḥ} YK\textsuperscript{qcr \cdot YSV} 1.256 Ed. p. 21) | sarvapāpavinirmukto jagatkṣobhakaro (\textit{jaganmokṣakaro} YK\textsuperscript{qcr \cdot YSV} 1.256 Ed. p. 21) mahān |}
...
\begin{edition}
 ...
 \bigskip
    \begin{prose}
    \noindent
\note[type=source, labelb=65, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): anāhatam aṣṭapīṭhaṃ (\textit{mahāpīṭhaṃ} YK\textsuperscript{qcr \cdot YSV} 1.257  Ed. p. 21) caturthakamalaṃ hṛdi | sūryapatraṃ mahājyotir mahāsūkṣman tu cākṣuṣam | sūryapatraṃ dvādaśadalam (sentence \om in YK\textsuperscript{qcr \cdot YSV}) | tanmadhye 'ṣṭadalaṃ padmam ūrddhavaktraṃ mahāprabham |}
%-----------------------
% \om                                                   \B
...
%%%%%%%%%%%%%%%
  \extra{manaś-cakre\dd{}
    mano devatā\dd{}
        ...
        \note[type=philcomm, labelb=68a, lem={bahiśśaktiḥ}]{The conjecture is based on the the usage in \citetitle[p. 96]{kriyakrama}. It can also be found in \citetitle[p. 80]{sakalagama}\textsuperscript{qcr \cdot siddhāntaśekhare}. Both texts use the term in the context of \textit{cakra}s, channels, breath-retention and visualization.}
    ...
    \label{cakra4trans}
       ...
       \begin{tlate}
         \noindent
           ...
           \extra{The mind resides in the \textit{cakra}. Manas is the deity. Bahi is the power\footnote{The term \textit{bahiśśaktiḥ} designates the visualization of the external energy infused by inhalation that permeates the body. \citetitle[p. 80]{sakalagama}\textsuperscript{qcr \cdot siddhāntaśekhare}:
      \begin{quote}
...
\note[type=source, labelb=72, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): padmavatyāḥ (\textit{padmāvatyāḥ} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) prabhāṅguṣṭhapramāṇā (°\textit{prāmāṇa}° YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) ratnasannibhā | tasyā saṅgī (\textit{tasya saṅgī} YK\textsuperscript{qcr \cdot YSV} 1.260 Ed. p. 21) jīva iti ananto balarūpataḥ | asya dhyānaṃ (\textit{dhyānād} YK\textsuperscript{qcr \cdot YSV} 1.260 Ed. p. 21) jagadvaśyaṃ khecarīsarvago bhavet | bhavanti vaśyā devādyāś cintākarttur na (\textit{citta°} YK\textsuperscript{qcr \cdot YSV} 1.260 Ed. p. 21) cānyathā | iṣṭāniṣṭo (\textit{iṣṭāniṣṭa} YK\textsuperscript{qcr \cdot YSV} 1.261 Ed. p. 21) bhaved vaśyaḥ (\textit{vaśyaṃ} YK\textsuperscript{qcr \cdot YSV} 1.261 Ed. p. 21) satyaṃ satyaṃ na saṃśayaḥ | iṣṭasiddhir bhavet tasya sarvajñādiguṇodayaḥ |}
tasyāḥ
...
\note[type=source, labelb=77, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832) = YK\textsuperscript{qcr \cdot YSV} 1.262 (Ed. p. 21): kalāpatraṃ pañcaman tu viśuddhaṃ kaṇṭhadeśataḥ |}
...
%-----------------------
\note[type=source, labelb=78a, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832) = YK\textsuperscript{qcr \cdot YSV} 1.262 (Ed. p. 21): asya madhye pumān ekaḥ koṭicandrasamaprabhaḥ | naśyantya sādhyarogā hi sahasrāyuś ca cintanāt |}
...
%-----------------------
    \begin{prose}
      \noindent
    \note[type=source, labelb=81, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): ājñākhyaṃ ṣaṣṭhakaṃ (\textit{ṣaṭkaṃ} YK\textsuperscript{qcr \cdot YSV} 1.264 Ed. p. 21) cakraṃ bhruvor madhye dvipatrakam | agnijvālānibhaṃ jyotiḥ puṃsaḥ strīto (\textit{pūṃsastrīto} YK\textsuperscript{qcr \cdot YSV} 1.264 Ed. p. 21) vivarjitam | dhyānāc cāsya sarvasiddhirajarāmaratāṃ vrajet |}
...
%-----------------------
      ...
      \note[type=source, labelb=87, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. pp. 832-833): catuḥṣaṣṭidalaṃ tālumadhye cakran tu madhyamam | pīyūṣapūrṇaṃ (\textit{pīyūṣapūrṇa°} YK\textsuperscript{qcr \cdot YSV} 1.266 Ed. p. 21) koṭīndusannibhaṃ (\textit{°sannibha°} YK\textsuperscript{qcr \cdot YSV} 1.266 Ed. p. 21) cāmṛtasthalī | tanmadhye ghaṭikāsaṃjñā karṇikā raktasannibhā | saha cendukalā tatrāmṛtadhārāṃ (\textit{tāndrā°} YK\textsuperscript{qcr \cdot YSV} 1.267 Ed. p. 21) sravaty asau | etad dhyātvāmṛtaiḥ snātvā sadā yogāt pramucyate |}
idānīṃ saptamaṃ
...
%-----------------------
      \note[type=source, labelb=87, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 833): unmādajvarapittādidāhaśūlādivedanāḥ (\textit{°śūnyā°} YK\textsuperscript{qcr \cdot YSV} 1.268 Ed. p. 21) | naśyanti ca śiroduḥkhaṃ jāḍyabhāvo 'pi naśyati | sadyodhyānādbhuktaviśvaṃ jihvājāḍyañ ca naśyati (last sentence \om in YK\textsuperscript{qcr \cdot YSV})}
...
%-----------------------
      ...
      \note[type=source, labelb=94, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 833): brahmarandhre 'ṣṭamaṃ cakraṃ śatapatraṃ mahāprabham | jālandharaṃ nāma pīṭhaṃ etat tu parikīrttitam | siddhapuṃsaḥ (\textit{°puṃsa°} YK\textsuperscript{qcr \cdot YSV} 1.270 Ed. p. 22) sthalaṃ jñātvā agnidhūmanibhā śikhā | ādimadhyāntahīnā strīpuṃmūrtti (\textit{°mūrtir} YK\textsuperscript{qcr \cdot YSV} 1.270 Ed. p. 22) varttate parā | antajñānī (\textit{antaryāmī} YK\textsuperscript{qcr \cdot YSV} 1.271 Ed. p. 22) bhaved dhyānād ākāśe 'pi samāgamaḥ | nirantaraṃ sarvavettā ity ūccāno mahān bhavet | jaganmadhye sthito jantur jagadbādhāvivarjitaḥ |}    
idānīṃ
...
%---------------------
\note[type=source, labelb=104, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 833):  ūrddhvavakraṃ mahāvaktre (\textit{mahāvaktraṃ} YK\textsuperscript{qcr \cdot YSV} 1.274 Ed. p. 22) varṇaśobhāpadaṃ mahat | sarvakalyāṇasampūrṇamasya tulyaṃ na vidyate | parimāṇaṃ vaktam (\textit{vaktum} YK\textsuperscript{qcr \cdot YSV} 1.275 Ed. p. 22) asya manasā vacasā na hi | trikoṇakarṇikā tatra (\textit{°tantraṃ} YK\textsuperscript{qcr \cdot YSV} 1.276 Ed. p. 22) varttate jagad īśvari | kalā saptadaśī tatra varttate parameśvari | nirañjanakalā sā tu koṭisūryasamaprabhā | koṭicandraprabhā caiva śītoṣṇādivivarjitā | asya dhyānāt sādhakasya manoduḥkhaṃ bhaven na hi | anantaparamānandasthānaṃ jñeyaṃ tadūrddhvataḥ (\textit{tadarddhataḥ} YK\textsuperscript{qcr \cdot YSV} 1.278 Ed. p. 22) | ūrddhvagatakalā tatra tasya dhyānād bhaved iti | iti siddhirājayogaṃ strīṇāṃ bhogaṃ mahāsukham | gītavādyavinodādi saśivaṃ varddhate kṣitau | dhyānaṃ nirantarañ cāsya puṇyapāpe sthire (\textit{sthirau } YK\textsuperscript{qcr \cdot YSV} 1.280 Ed. p. 22) na hi | nijarūpasya dṛṣṭiḥ syād dūrasyārthañ ca paśyati ||}
...
%------------------------------
      \note[type=source, labelb=109, lem={\textbf{Re}}]{YK\textsuperscript{qcr \cdot YSV} 2.1 Ed. p. 23: sukhasādhyaṃ lakṣayogam idānīṃ śrṛṇu pārvati | pañcadhā lakṣayogaś ca ūrdhvalakṣādibhedataḥ (\textit{ūrddha} PT\textsuperscript{qcr \cdot YSV} Ed. p. 833) ||}  
      idānīṃ
...
%------------------------------
  \note[type=source, labelb=112, lem={\textbf{Re}}]{YK\textsuperscript{qcr \cdot YSV} 2.3 Ed. p. 23: lakṣaṇaṃ śrṛṇu caiṣāṃ hi phalaṃ jñātvā maheśvari | ākāśe dṛṣṭim āsthāya mana ūrdhvan (\textit{ūrddhan} PT\textsuperscript{qcr \cdot YSV} Ed. p. 834) tu kārayet ||3||}
...
%------------------------------
\note[type=source, labelb=113, lem={\textbf{Re}}]{YK\textsuperscript{qcr \cdot YSV} 2.3-2.4ab Ed. p. 23: ūrdhvalakṣaṃ  (\textit{ūrdha°} PT\textsuperscript{qcr \cdot YSV} Ed. p. 834)  bhaved eṣā parameśasya caikatā |}
  etasya
...
%------------------------------
\note[type=source, labelb=115a, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 834): antarlakṣaṃ śṛṇu śukradigvidigādivarjitam (\textit{subhru°} YK\textsuperscript{qcr \cdot YSV} 2.8a Ed. p. 24) | calaj jāgratsuṣupteṣu bhojaneṣu ca sarvadā | sarvāvasthāsu deveśi cittaṃ śūnye niyojayet | karttā kārayitā śunyaḥ (\textit{śūnyaṃ} YK\textsuperscript{qcr \cdot YSV} 2.10a Ed. p. 24) mūrttimān śūnya īśvaraḥ | harṣaśokaghaṭastho 'yaṃ janmamṛtyū labhet svayam | ghaṭasthā cintyayor mūrttir hatacintāsvarūpadhṛk (\textit{ghaṭasthāṃ cintayen mūrttimitaś} YK\textsuperscript{qcr \cdot YSV} 2.11ab Ed. p. 23) | viṣayaṃ viṣavad duṣṭaṃ (\textit{dṛṣṭvā} YK\textsuperscript{qcr \cdot YSV} 2.11c Ed. p. 23) tyaktvā jñātvā tu mārutam | saṃjñāśūnyamanā bhūtvā puṇyapāpair na lipyate | bāhyam ābhyantaraṃ khaṃ (\textit{yad} YK\textsuperscript{qcr \cdot YSV} 2.12c Ed. p. 24) hi antarlakṣam iti smṛtam | etad dyānāt sadā kiñcid duḥkhaṃ na syāc chivo bhavet | śūnyan tu saccidānandaṃ niḥśabdaṃ brahmaśabditam | saśabdaṃ jñeyam ākāśam (\textit{ākāśa} YK\textsuperscript{qcr \cdot YSV} 2.13c Ed. p. 24) iti bhedadvayan tv iha |}
...
\end{prose}
  ...
  He dwells on earth having pervaded [it]. Both, birth and death do not exist.\footnote{In \citetitle{birch2013} 1.27 the yogin in \textit{samādhi} is described as neither alive nor dead, lifeless like a piece of wood (na ca jīvan mṛto vāpi na paśyati na mīlati | nirjīvaḥ kāṣṭhavat tiṣṭhel layasthaś cābhidhīyate |); also Cf. \citetitle{sarvangayoga} 19d (jarā na vyāpai kāla na ṣāī |) ``he does not know old age and death '' and 20c (ajar amar ati bajraśarīrā |) ``\ldots non-ageing, immortal supreme diamond body.''}\textsuperscript{\coro{[\lowroman{5}]}} Happiness does not exist. Suffering does not exist.\footnote{Equanimity towards happiness and suffering or other opposites in the state of Rājayoga are commonly found among texts that teach Rājayoga, cf. e.g. \citetitle{birch2013} 1.26ab (sukhaṃ duḥkhaṃ na jānāti śītoṣṇaṃ ca na vindati |); \citetitle{hp} 4.111 ≈ \citetitle{nadabindu} 53ab−54cd: (na vijānāti śītoṣṇaṃ na duḥkhaṃ na sukhaṃ tathā | na mānaṃ nopamānaṃ ca yogī yuktaḥ samādhinā ||); also cf. \citetitle{sarvangayoga} 3.18cd: (jākaiṃ dukh aru sukh nahiṃ koī | harṣ śok vyāpai nahiṃ koī || 18 ||) ``for whom neither sorrow nor joy matters, and neither joy nor sorrow overwhelms him.''} Impediment does not exist.\footnote{Cf. \citetitle{sarvangayoga} 3.22: (icchā parai tahāṃ so jāī | tīni lok mahiṃ aṭak na kāī | svarg jāī devani mahiṃ baithai | nāgalok pātāl su paiṭhai || 22 ||) ``He goes where he wants without being stopped in the three worlds, he goes to heaven and sits with the gods, he goes to the underworld and subdues the demons.''} Moral conduct (\textit{śīla}) does not exist.\footnote{Cf. \citetitle{datta2015} 162.} Place does not exist.\textsuperscript{\coro{[\lowroman{10}]}} The manifestation of a permanent perception of the connection with god arises within the mind of the accomplished one. Moreover, he is shining - not cold, hot, white or yellow.\footnote{Cf. \citetitle{birch2013} 1.51: (vāsarārdhalayenāpi svātmajyotiḥ prakāśate | sūryo gobhir ivoddīpto yogī viśvaṃ prakāśate || 51 ||); Cf. \citetitle{sarvangayoga} 3.13cd: (rājayog sab ūpara chājai | jo sādhai so adhik birājai || 13 ||) ``Rajayog is supreme and those who practice it shine even more.'' and Cf. \citetitle{sarvangayoga} 3.23cd: (hṛdai prakāś rahai din rātī | deśai jyoti tel bin vātī || 23 ||) ``The light in his heart remains bright day and night, without oil.''}
...
\app{\lem[wit={ceteri}]{bhedaḥ}
  \rdg[wit={B,L}]{bhedāḥ}}
\app{\lem[wit={ceteri}]{kathyate}
  \rdg[wit={B,L}]{kathyante}}/ \note[type=source, labelb=132, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 835): idānīṃ haṭhayogasya dvitīyaṃ bhedam acchṛṇu | ākāśe nāsikāgre tu sūryakoṭisamaṃ smaret | śvetaṃ raktaṃ tathā pītaṃ kṛṣṇam ity ādirūpataḥ | evaṃ dhyātvā cirāyus syād aṅgājananavarjitam (\textit{°varjitaḥ} YK\textsuperscript{qcr \cdot YSV} 12.25 Ed. p. 108; possibly em. to aṅgajaraṇavarjitaḥ or aṅgajvaranavarjitaḥ) | śivatulyo mahātmāsau haṭhayogaprasādataḥ (\textit{°prasaṅgataḥ} YK\textsuperscript{qcr \cdot YSV} 12.25 Ed. p. 108) | haṭhāj jyotir (\textit{haṭha°} YK\textsuperscript{qcr \cdot YSV} 12.26 Ed. p. 108) mayo bhūtvā hyantareṇa śivo bhavet | ato 'yaṃ haṭhayogaḥ syāt siddhidaḥ siddhasevitaḥ |}
%------------------------------
...
\note[type=source, labelb=185, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839) = YK\textsuperscript{qcr \cdot YSV} 1.37 (Ed. p. 26): ākāśan tu mahākāśaṃ parākāśaṃ parātparam | tattvākāśaṃ sūryakāśamākāśaṃ pañcalakṣaṇam |}
...
%-----------------------------SSP!
\note[type=source, labelb=187, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): sabāhyābhyantare nityaṃ nirākāśantu (\textit{nirākāśas tu} YK\textsuperscript{qcr \cdot YSV} 2.38 Ed. p. 26) nirmalam | karttavyaṃ lakṣam ākāśaṃ sādhayet sādhanaṃ vinā | ghanāntarālasadṛśaṃ parākāśaṃ tathaiva ca |}
tataḥ
...
%-----------------------------SSP!
\note[type=source, labelb=190, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): kalpāntāgnisamaṃ (\textit{kālāntāgnisamaṃ} YK\textsuperscript{qcr \cdot YSV} 2.39cd Ed. p. 26) jyotir mahākāśaṃ smaret tathā |}
...
\note[type=source, labelb=194, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839) = YK\textsuperscript{qcr \cdot YSV} 2.40ab (Ed. p. 26): koṭikoṭipradīpābhaṃ tattvākāśaṃ smaret tathā |}
...
The fixations of them are taught: Space, beyond space, great space, space of reality, the space of the sun. The fixation onto the pure and formless space (\textit{akāśa}) shall be done internally as well as externally. Therafter, the fixation of the beyond-space (\textit{parākāśa}) which is equal to dense darkness\footnote{Instead of extreme brightness as in the \citetitle{ssplonavla} (Ed. p. 29) and \ldots} shall be done internally and externally. Then, the fixation of the great space (\textit{mahākāśa}) which is the plethora of the burning fire of the time of dissolution shall be done internally and externally. Then, when internally and externally the brightness of millions of blazing lights arises, he shall execute the fixation [directed onto] the reality-space (\textit{tattvakāśa}) which is as such.\end{tlate}
  \end{translation}
\end{alignment}
%\ekdpb*{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\note[type=source, labelb=196, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): sūryākāśaṃ tathā koṭisūryavindusamaṃ (\textit{°bimbasamaṃ} YK\textsuperscript{qcr \cdot YSV} 2.40d Ed. p. 26) smaret | sabāhyābhyantare caivam ākāśaṃ (\textit{caiva sākāśaṃ} YK\textsuperscript{qcr \cdot YSV} 2.41b Ed. p. 26) lakṣayet tu yaḥ |}
...
%-----------------------------
\note[type=source, labelb=196, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): śivavad vihare dviśve pāpapuṇyavivarjitaḥ | eteṣāñ caiva lakṣeṇa karmadvārā 'ghamāharet (\textit{karmmadvārānapāharet} YK\textsuperscript{qcr \cdot YSV} 2.41d Ed. p. 26) |}
...
\note[type=source,  labelb=198,  lem={\textbf{Ci}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832) = YK\textsuperscript{qcr \cdot YSV} 2.14 (Ed. p. 24): navacakraṃ kalādhāraṃ trilakṣaṃ vyomapañcakam | svadehe yo na jānāti sa yogī nāmadhārakaḥ |}
...
\note[type=testium, labelb=198ax, lem={\textbf{Cie}}]{\citetitle{yogatarangini} qcr \cdot \textit{Nityanāthapaddhati} (Ed. p. 72) = \citetitle{hathatattvakaumudi} 24.1: ṣaṭcakraṃ ṣoḍaśādhāraṃ dvilakṣyaṃ vyomapañcakam | svadehe ye na jānanti kathaṃ siddhyanti yoginaḥ |}
...
\note[type=testium, labelb=198f, lem={\textbf{Cee}}]{\citetitle{mandalabrah} 3.4.5: navacakraṃ ṣaḍādhāraṃ trilakṣyaṃ vyomapañcakam | samyag etan na jānāti sa yogī nāmato bhavet |}
...
\end{tlg}
  ...
  \begin{translation}
    ...
    \begin{tlate}
      \noindent
      \blfootnote{\ldots \citetitle{advaya} (Ed. p. 5), Rāmacandra has choosen promotes dense darkness in his \textit{parākāśa}-visualization.}
...
\begin{alignment}[
  ...
  \begin{edition}
\ekddiv{type=ed}
\centerline{\textrm{\small{[\uproman{31}.\textsuperscript{\coro{\lowroman{1}-\lowroman{50}}}The Sixteen Ādhāras]}}}
 \bigskip
 \begin{prose}
   \noindent
%-----------------------------
...
%-----------------------------
   \note[type=source, labelb=211, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832) = YK\textsuperscript{qcr \cdot YSV} 2.15 (Ed. p. 24): ṣoḍaśādhārabhedan tu śṛṇu devi viśeṣataḥ |}
   \note[type=source, labelb=210, lem={\textbf{Re}}]{SSP 2.1 (Ed. p. 29): atha ṣoḍaśādhārāḥ kathyante |}
...
%-----------------------------
\note[type=source, labelb=213, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): aṅguṣṭhapādayos tejaḥ salakṣasthiradṛṣṭimān | pādāṅguṣṭhe ya ādhāraḥ prathamo (\textit{prathamaṃ} YK\textsuperscript{qcr \cdot YSV} 2.16 Ed. p. 24) yogatattvataḥ |}
\note[type=source, labelb=212, lem={\textbf{Re}}]{SSP 2.10 (Ed. p. 32): tatra prathamaḥ pādāṅguṣṭhādhāraḥ | tatrāgratas tejomayaṃ dhyāyet | dṛṣṭiḥ sthirā bhavati |}
...
%-----------------------------
 \note[type=source, labelb=216, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): dvitīyaṃ pādamūlan tu pādamūlaparaṃ (\textit{pādamūlaṃ paraṃ} YK\textsuperscript{qcr \cdot YSV} 2.16 Ed. p. 24) sa vai | pādasya pārṣṇī (\textit{pārṣṇi} YK\textsuperscript{qcr \cdot YSV} 2.17a, Ed. p. 24) saṃsthāpya balavān prabhaven muniḥ | pādamūle 'thavā pādāṅguṣṭhamūlaṃ (\textit{pṛṣṭhe pādāṅguṣṭhe} YK\textsuperscript{qcr \cdot YSV} 2.17 Ed. p. 24) vidhārayet ||}%The second is the root of the foot. That root of the foot is truly superior. Having placed himself on the heel of the foot the Muni becomes powerful. He shall hold [the gaze?] at the root of the foot or at the big toe.
...
%-----------------------------
\note[type=source, labelb=218, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): tṛtīyan tu gudādhāro (\textit{gudādhāre} YK\textsuperscript{qcr \cdot YSV} 2.18 Ed. p. 24) gudasaṅkocanakriyā | vikāśākuñcanaṃ tasya sthiravāyau ca mṛtyujit |}
...
\end{prose}
  ...
  \begin{translation}
    ...
    \begin{tlate}
      \noindent
      Now the divisions of the totality\footnote{I propose to understand \textit{cakra} here in the less common meaning of "troup, crowd, totality", cf. \citeauthor[vol. 2, 1958:209]{petersburger}.} of supports\footnote{The yogic practice of sixteen \textit{ādhāra}s goes back to more ancient yoga traditions of Śaivism and is mentioned in texts such as \citetitle{tantraloka}, \citetitle{manthana} and \citetitle{netratantra}. It appears that the techniques were passed on and recycled across the centuries among yoga traditions of Haṭha- and Rājayoga. Besides Rāmacandra's text the other texts which present full lists of the sixteen \textit{ādhāra}s are: \textit{Netroddyota}-commentary of Kṣemarāja on \textit{Netratantra} 7.5; \citetitle{sarada} 25.24-25; \citetitle{shivayogapradipika} 3.17-33; \citetitle{ssplonavla} 2.10-25; \citetitle{yogatarangini} 1.13 (Ed. p. 72-73) quotation with reference ``\textit{nityanāthapaddhatau}'' (maybe another recension of the \citetitle{ssplonavla}, see \citeauthor[2023:149]{shivayogapradipika}); \citetitle{hathatattvakaumudi} 24.10-23; and \citetitle{jyotsna} on \citetitle{hathapradipika2024}, as well \citetitle{ramatosana} (Ed. p. 839-841) quotation with reference ``\textit{yogasvarodaye}'' and \citetitle{yogakarnika} quotation with reference ``\textit{yogasvarodaye}'' 14-36. Comparing the various lists of \textit{ādhāra}s reveals a significant variability. Rāmacandra's system is certainly derived from the \textit{Yogasvarodaya}. This passage additionally suggests clear influences from the \citetitle{ssplonavla}. As \citeauthor[2023:151]{shivayogapradipika} discussed, the \citetitle{shivayogapradipika} was probably the source text of the \citetitle{ssplonavla}.} [for concentration] are taught.\footnote{Most of the previously mentioned \textit{cakra}s overlap with the \textit{ādhāra}s, except for the \textit{ākāśacakra}.}
      The first is the support at the big toe. From the execution of the fixation onto the light at the big toe of the feet stability of the gaze arises.\footnote{In all previously mentioned systems the big toe is the first \textit{ādhāra}. In most texts the practicioner is instructed to fixate the mind onto the big toe - either one shall visualize a light there (as in \citetitle{shivayogapradipika}) or the light is already present. \citetitle{sarada}, however, instructs to fix \textit{prāṇa} (the practitioner holds mind and breath at the respective locations) onto each \textit{ādhāra} listed. Here, the practice of the \textit{adhāra}s is subsumed under the \textit{dhāraṇā} limb in an eight-fold (\textit{aṣṭāṅga}) yoga system. The remainder of texts simply lists the \textit{adhāra} without further instructions.}  
      The root support is the second [one]. \crazy{The heel of the other foot is caused to be placed at the root of the big toe. As a result the fire is strengthened.}\textsuperscript{\coro{[\lowroman{5}]}} One heel is caused to be placed at the Root-container. The heel of the other foot is caused to be placed at the root of the big toe of this foot. The fire of it is caused to be kindled.\footnote{Either the text is corrupted here or Rāmacandra did not understand the \textit{Yogasvarodaya}. This might have caused him to addionally draw from the description of the \citetitle{ssplonavla} hhich resulted in the two separate descriptions. \textit{Netroddyota}, \citetitle{sarada} and \citetitle{jyotsna} give the ankle (\textit{gulpha}) as the second \textit{adhāra}.}  
      The third is the location of the anus support. From the execution of expansion and contraction a stable vitalwind arises.\textsuperscript{\coro{[\lowroman{10}]}} And therefore death of the person does not arise.\footnote{\textit{Netroddyota}, \citetitle{sarada} and \citetitle{jyotsna} provide the knee (\textit{jānu}) as the third \textit{adhāra}.} 
    \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
%-----------------------------
      \note[type=source, labelb=220, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. pp. 839-840): liṅgādhāraṃ caturthan tu liṅgasaṅkocanan tu ca | liṅgasaṅkocanābhyāsāt paścimādaṇḍamadhyagaḥ | vajranāḍīti (\textit{vajrānāḍī tu} YK\textsuperscript{qcr \cdot YSV} 2.20 Ed. p. 24) tanmadhye punar abhyasayaṃs (\textit{abhyasanan} YK\textsuperscript{qcr \cdot YSV} 2.20 Ed. p. 24) tathā | sañcāro vāyumanasor atisañcāra iti (\textit{ratiṃ sañcarati} YK\textsuperscript{qcr \cdot YSV} 2.20 Ed. p. 24) tridhā | granthitrayavibhedas (\textit{°bhedan} YK\textsuperscript{qcr \cdot YSV} 2.21 Ed. p. 24) tu tadbhedo brahmamārgataḥ | brahmapadmo (\textit{°padme} YK\textsuperscript{qcr \cdot YSV} 2.21 Ed. p. 24) vāyupūrṇo (\textit{°pūrṇe} YK\textsuperscript{qcr \cdot YSV} 2.21, Ed. p. 24) bhūtvā tiṣṭhati yogirāṭ | vīryastambho bhavet tena sādhayet tu sadā yuvā | mūlādhāre brahmapadme ṣaṭpadme ca tathā tathā |}
...
%-----------------------------
\note[type=source, labelb=222, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): pañcamaṃ jaṭharādhāraṃ tadā bandhayati kramāt | mṛtyunā bhaṅgasiddho 'yaṃ (\textit{mṛtyunā māṅga°} YK\textsuperscript{qcr \cdot YSV} 2.23 Ed. p. 25) mṛtyor (\textit{mṛtyur} YK\textsuperscript{qcr \cdot YSV} 2.23 Ed. p. 25) eva kṣayaṅkaraḥ | anena paścimād ūrddhaṃ (\textit{ūrdhvaṃ} YK\textsuperscript{qcr \cdot YSV} 2.24 Ed. p. 25) vāyuḥ kuryād viśāladhīḥ | bandho 'yaṃ buddhimanasoḥ pañcamādhārakālajit |}
...
\app{\lem[wit={ceteri}]{paṃcamaṃ}
  \rdg[wit={B}]{paṃcama}
  \rdg[wit={N2}]{paṃcam}}
\app{\lem[wit={P,U2}]{uḍḍīyāṇaṃ svādhiṣṭhānaṃ}
...
\note[type=philcomm, labelb=223, lem={\uproman{31}\textsuperscript{\lowroman{19}}}]{Spellings for this component of the yogic body vary across yogic literature. \getsiglum{B}, \getsiglum{E}, \getsiglum{L}, \getsiglum{P}, \getsiglum{U2} add the expression \textit{svādhiṣṭhānaṃ} which was associated with the \textit{pīṭha} in chapter \uproman{5}.\textsuperscript{\lowroman{1}}.}
tatra
...
%-----------------------------
\note[type=source, labelb=225, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): nābhyādhāro bhavet ṣaṣṭhas (\textit{ṣaṣṭhaṃ} YK\textsuperscript{qcr \cdot YSV} 2.25 Ed. p. 25) tatra prāṇaṃ samabhyaset | svayam utpadyate nādo nādato muktidantataḥ (\textit{muktidaṇḍataḥ} YK\textsuperscript{qcr \cdot YSV} 1.25 Ed. p. 25) |}
...
\app{\lem[wit={ceteri}]{nābhyādhāraḥ}
  ...
  \rdg[wit={U2}]{nābhyādhāre}}/\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{20}]}\end{otherlanguage}}
...
\note[type=source, labelb=227, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): saptamo hṛdayādhāras tasmin vāyunibandhanāt | ūrddhaktrāṇi (\textit{ūrdhvavaktrāṇi} YK\textsuperscript{qcr \cdot YSV} 2.26 Ed. p. 25) padmāni vikasanti mahān bhavet |}
\crazy{\app{\lem[wit={ceteri}]{saptamo}
  \rdg[wit={E,B}]{\om}}
...
%-----------------------------
\note[type=source, labelb=229, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840) =  YK\textsuperscript{qcr \cdot YSV} 2.27 Ed. p. 25: kaṇṭhādhāro 'ṣṭamas tatra kaṇṭhasaṅkocalakṣaṇaḥ | jālandharākhyo bandhaḥ syāt tasmin sati marud dṛḍhaḥ |}
...
%-----------------------------
\note[type=source, labelb=231, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): navamo ghaṇṭikādhāras tatra jihvāgramagrataḥ (\textit{jihvāgrataḥ kṛte} YK\textsuperscript{qcr \cdot YSV} 2.28 Ed. p. 25) | sampivatyamṛtaṃ tasmād yogajinmṛtyujitparaḥ |}
...
%-----------------------------
\note[type=source, labelb=233, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): daśamas tālukādhāras tatra jihvāgrataḥ kṛte (hemistich \textit{\om} YK\textsuperscript{qcr \cdot YSV} | calane dohane caiva jihvā jaḍati lambitā (\textit{jāyeta lambitam} YK\textsuperscript{qcr \cdot YSV} 2.28cd Ed. p. 25) | nāsikāprāptajihveyaṃ tālulagnā bhavet tataḥ |}
...
\app{\lem[wit={ceteri}]{tiṣṭhati}
  ...
  \begin{translation}
    ...
    \begin{tlate}
      \noindent
      The sixth is the support of the navel. From the repeated practice of \textit{praṇava}, the unstruck sound arises by itself.\footnote{There are interesting differences for the sixth \textit{adhāra} among the texts: \citetitle{ssplonavla} instructs recitation of \textit{oṃ} at the navel, \citetitle{yogatarangini} adds meditation on the form of consciousness (\textit{cidrūpam}) to the same recipe, whereas in \citetitle{hathatattvakaumudi} the breath should be restrained at the navel, which causes the rising of the sound of \textit{oṃ} into emptiness. In the \textit{Yogasvarodaya}, the restraint of breath in the navel causes the \textit{nāda} to arise on its own. However, \citetitle{shivayogapradipika} instructs to contemplate Kuṇḍalinī at the navel. \textit{Netroddyota} lists the \textit{kanda} as the sixth support.}

      \crazy{The seventh is the support of the heart-form. From the restraint of the breath in this location the six upward facing lotusses blossom.}\footnote{Rāmacandra's mention of \textit{ṣaḍapi kamalāny} ``six lotusses'' in this context is odd, possibly textual corruption. The result of the practice in \citetitle{ssplonavla}, \textit{Yogasvarodaya} and \citetitle{yogatarangini} is confined to the blossoming of the heart lotus. In the \citetitle{hathatattvakaumudi} it is not the heart itself, but consciousness blossoming in the heart. In \citetitle{shivayogapradipika} the heart center consists of a downward-facing eight-petaled lotus and is declared as the bestower of one's desires. Here, one should bring the mind into the pericarp (\textit{karṇikā}) in the form of a \textit{liṅga} of light. \textit{Netroddyota} lists the term ``\textit{nāḍi}'' as the seventh \textit{adhāra}. It is described as the middle path between navel and heart and considered the abode of all desires (nābhihṛnmadhyamārge tu sarvakāmābhidho mataḥ |), whereas \citetitle{sarada} and \citetitle{jyotsna} list the navel as the seventh \textit{adhāra}.}

      The throat support is the eighth. There the binding of Jālaṅdhara\footnote{This passages again demonstrates how Rāmacandra is jumping between sources. In chapter \uproman{11} he situated Jālaṅdhara at the \textit{brahmarandhra}. A discussion of the term can be found at p. \pageref{cakra8trans}.} is produced.\textsuperscript{\coro{[\lowroman{25}]}} While abiding therein the vitalwind in the Iḍā and Piṅgalā channel becomes stable.\footnote{\textit{Netroddyota} places the support at the belly (\textit{jaṭhara}). \citetitle{sarada} and \citetitle{jyotsna} place the eight support in the heart. All other text present the same concept.}

      The ninth is the support of the uvula. There the tip of the tongue becomes attached [to the uvula]. Because of that the nectar of immortality flows from the immortality digit. From drinking the nectar of immortality diseases do not spread in the body.\footnote{Almost all texts share this concept. Only \citetitle{sarada} and \citetitle{jyotsna} situate the ninth support at the neck (\textit{grīva}) and \textit{Netrodyota} at the heart.} \textsuperscript{\coro{[\lowroman{30}]}}
      
      The tenth is the support of the palate. After the moving and milking has been done therein, [and] while abiding at entrance of the uvula, the tongue resides inserted within the palate.\footnote{The ninth, tenth, eleventh and twelfth support in this text resemble are all associated with \textit{khecarīmudrā} and its forerunners. Already the Buddha himself tried forced his tongue against his palate. For a detailled account of \textit{khecarīmudrā}, see \citeauthor{mallinson2010}.} Most other texts share the instructions for the tenth support. \textit{Netrodyota} places the tenth support at the turtoise channel (\textit{kūrmanāḍī}), whereas \citetitle{sarada} and \citetitle{jyotsna} situate it at the throat \textit{kaṇṭha}.} 
    \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
%----------------------------
\note[type=source, labelb=235, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): ekādaśī (\textit{ekādaśo} YK\textsuperscript{qcr \cdot YSV} 2.29 Ed. p. 25) bhavej jihvā talajādhāra īśvari | jihvāgramathane tasmin pānīyaṃ madhuraṃ bhavet | tatpīteṣu kavir gītijyotiś (\textit{gītir} YK\textsuperscript{qcr \cdot YSV} 2.29 Ed. p. 25) chandovidāṃ (\textit{chandovidur} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) varaḥ |}
...
%----------------------------
\note[type=source, labelb=237, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 840): dantādhāro (\textit{dvandvādhāro} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) dvādaśeti sarvarogakṣayaṅkaraḥ (\textit{sarvarogaḥ} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) | dhārayed dantayor madhye jihvāgrañ ca balād api | dhṛtvārddhaghaṭikāmātraṃ sarvarogan (\textit{sarvarogāṃs} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) tu nāśayet |}
...
\note[type=philcomm, labelb=236, lem={\uproman{31}.\textsuperscript{\lowroman{36}-\lowroman{38}}}]{SSP 2.21 (Ed. p. 36) can not be considered a source or testimonia here since it teaches the brows as the twelfth \textit{adhāra} (dvādaśe bhrūmadhyādhāre tatra candramaṇḍalaṃ dhyāyet śītalatāṃ yāti |). Rāmacandra must have used both texts, the \citetitle{ssplonavla} and the \textit{Yogasvarodaya} and switched between both sources when compiling his text.}
tadupari
...
%----------------------------
\note[type=source, labelb=239, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 832): nāsādhāras tato (\textit{tataḥ} YK\textsuperscript{qcr \cdot YSV} 2.259 Ed. p. 21) jñeyo nāsālakṣas trayodaśaḥ (\textit{trayodaśa} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) | manaḥsthirakaro yas tu (\textit{sthiraṃ karoty eva} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) vāyusthirakaro (\textit{vāyuḥ} YK\textsuperscript{qcr \cdot YSV} 1.259 Ed. p. 21) mahān |}
...
%-----------------------------
\note[type=source, labelb=241, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839) =  YK\textsuperscript{qcr \cdot YSV} 2.33ab-34cd Ed. p. 25): nāsāpuṭe sthirā dṛṣṭir ādhāro 'yaṃ caturdaśaḥ | kṛte 'smin svīyatejaḥ syāt pratyakṣaṃ ṣaṭtrimāsataḥ | pārthivaṃ truṭati kṣipraṃ pratyakṣaṃ svīyatejasā |}
...
%----------------------------
\note[type=source, labelb=243, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 839): pañcadaśo bhruvormadhye sthira (\textit{sthirā} YK\textsuperscript{qcr \cdot YSV} 2.35 Ed. p. 25) dṛṣṭis tathā dhruvam | asmin dṛṣṭiḥ sthirā koṭiḥ (\textit{koṭi°} YK\textsuperscript{qcr \cdot YSV} 2.35 Ed. p. 25) kiraṇāni sphuranti hi |}
...
%-----------------------------
\note[type=source, labelb=246, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. pp. 840-41): netrādhāraḥ ṣoḍaśo 'yam (\textit{aṅgulyagre na} YK\textsuperscript{qcr \cdot YSV} 2.36 Ed. p. 25) aṅgulyagreṇa cālayet | pṛthvīmadhye tu yatkiñcid varttate (\textit{sarvajñaḥ prabhavas tena varddhate} YK\textsuperscript{qcr \cdot YSV} 2.36 Ed. p. 25) jaṭharānalaḥ | pratyakṣaṃ tad bhavet sarvaṃ tad ābhyāsān na saṃśayaḥ |}
...
\app{\lem[wit={ceteri}]{bhavati}
  ...
  \begin{translation}
    ...
    \begin{tlate}
      \noindent
      The fourteenth is the support of the vital wind at the root of the nose. From the execution of stabilizing the gaze therein, direct perception of one's own light arises within sixty months. One breaks all bonds of the mundane with by direct perception of the light.\footnote{\textit{Yogasvarodaya} as well as \citetitle{ssplonavla} with the term ``\textit{kapāṭādhāra}'' and \citetitle{yogatarangini} teach the base of the nose as the fourteenth \textit{adhāra}. All other texts teach fixing the mind and/or the breath at the forehead. \textit{Netrodyota} mentions that this place is called a wish-fulfilling jewel with its abode at the crossroads of the four channels (cintāmaṇyabhidhānākhyaś catuṣpathanivāsi yat ||).}     
            
      The fifteenth container is situated in the middle of the eyebrows. Due to stabilized the gaze therein, ten million rays of light sparkle.\footnote{A comparison with the other texts reveals interesting differences: \citetitle{shivayogapradipika} teaches gazing above the brows, which quickly brings about the appearance of light. \citetitle{ssplonavla} calls it the ``support of the forehead'' (\textit{lalāṭādhāra}), in which the practitioner shall visualize a cluster of light by which one becomes lustrous. \citetitle{yogatarangini} again teaches the center of the brows. By concentrating on this point, a direct vision of many-rayed light occurs, and one's mind will merge into the sun-sky (etasya dṛḍhābhyāse sūryākāśo līyate |). \citetitle{hathatattvakaumudi} calls it the ``support of ether'' (\textit{vyomādhāra}) and explains that by gazing at it, everything is perceived as light. However, \textit{Netratantra} teaches the \textit{brahmarandhra} as the fifteenth support. \textit{Netrodyora} declares it as the ``support ot the fourth state'' (\textit{turyādhāra}) and \citetitle{sarada} as well as \citetitle{jyotsna} also teach the top of the head (\textit{mūrdhan}) as the fifteenth.} \textsuperscript{\coro{[\lowroman{45}]}}
      
      [If the gaze] is held at the tip of the finger without wavering, this is the eye support, the sixteenth. Through that practice, some light arises from within the earth. The entire light of it becomes the object of vision. Through its perception, a person becomes omniscient.\footnote{The \textit{netrādhāra} is also taught in other texts. Some noteworthy differences exist: \citetitle{shivayogapradipika} teaches to fix [the gaze] above the eyes. Due to that, the yogin sees a mass of light in the corner of his eyes. \citetitle{yogatarangini} instructs the yogin to rub the eyes with the fingers. \citetitle{hathatattvakaumudi} teaches to meditate upon the eyes. By seeing a mass of light in the corner of the eyes, one soon becomes like Śiva. Both, Rāmacandra and \textit{Yogasvarodaya} instruct the practitioner to hold the gaze at the fingertip without wavering. However, the results differ slightly: instead of just becoming omniscient, the \textit{Yogasvarodaya} adds that the yogin becomes mighty (\textit{prabhava}) and an increase of gastric fire (\textit{jaṭharāgni}). \citetitle{ssplonavla} teaches to visualize the pair of the lotus feet of the revered teacher (\textit{śrīgurucaraṇāmbujayugmaṃ}) at the \textit{brahmarandhra} in which the \textit{akāśacakra} is situated. \citetitle{jyotsna}, too, lists the \textit{brahmarandhra}. \citetitle{sarada} and \textit{Netratantra} teach the \textit{dvādaśānta} which is twelve fingers above the \textit{brahmarandhra}, cf. \citetitle{tantrika3}, p. 210. \textit{Netrodyota} explains: ``The support of the [central?] channel is the highest subtle one which awakens complete pervasion.'' (nāḍyādhāraḥ paraḥ sūkṣmo ghanavyāptiprabodhakaḥ ||).}\textsuperscript{\coro{[\lowroman{50}]}}
    \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
    \centerline{\textrm{\small{[\uproman{32}.\textsuperscript{\coro{\lowroman{1}-\lowroman{15}}}Aṣṭāṅgayoga]}}}
    \bigskip
    \begin{prose}
        \noindent
%----------------------------
...
%----------------------------
\note[type=source, labelb=248, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841): idānīṃ yogam aṣṭāṅgaṃ śṛṇu lakṣaṇasaṃyutam |}
\note[type=source, labelb=248a, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841) = YK\textsuperscript{qcr \cdot YSV} 5.29-30ab (Ed. pp. 62-63): yamaś ca niyamaś caiva cāsanaṃ prāṇasaṃyamaḥ | pratyāhāro dhāraṇā ca samādhiś ca viśeṣataḥ | aṣṭāṅgayoga ebhis tu caiteṣāṃ lakṣaṇaṃ śṛṇu |}
\note[type=source, labelb=247, lem={\textbf{Re}}]{SSP 2.32 (Ed. p. 45): yamaniyamāsanaprāṇāyāmapratyāhāradhāraṇādhyānasamādhayoḥ 'ṣṭāṅgāni |}
...
%----------------------------
\note[type=source, labelb=250, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 842): śāntiḥ santoṣa āhāro nidrālpā (\textit{nidrālpaṃ} YK\textsuperscript{qcr \cdot YSV} 5.30 Ed. p. 63) manaso damaḥ | śūnyāntaḥkaraṇañ ceti (\textit{°karaṇaś ceti} YK\textsuperscript{qcr \cdot YSV} 5.31 Ed. p. 63) yamā iti prakīrttitāḥ |}
\note[type=source, labelb=249, lem={\textbf{Re}}]{SSP 2.32 (Ed. p. 44): tatra yama iti upaśamaḥ sarvendriyajayaḥ āhāranidrāśītavātātapajayaś caivaṃ śanaiḥ śanaiḥ sādhayet |}
...
\app{\lem[wit={ceteri}]{yamāḥ}
  ...
  \rdg[wit={B,L}]{yamaḥ}}\dd{}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
%----------------------------
...
%----------------------------
\note[type=source, labelb=252, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841): cāpalyan tu dūre tyaktvā (\textit{tyaktvā dūre tu cāpalyaṃ} YK\textsuperscript{qcr \cdot YSV} 5.31cd Ed. p. 63) manaḥ sthairyyaṃ vidhāya ca | ekatra melanaṃ nityaṃ prāṇāmātre na sā matiḥ (\textit{sāmabhiḥ} YK\textsuperscript{qcr \cdot YSV} 5.32c Ed. p. 21) | sadodāsīnabhāvas tu sarvatrecchāvivarjanam (\textit{°vivarjitaḥ} YK\textsuperscript{qcr \cdot YSV} 5.32d Ed. p. 21)| yathālābhena santuṣṭaḥ parameśvaramānasaḥ | mānadānaparityāga ete tu niyamā iti |}
\note[type=source, labelb=252a, lem={\textbf{Re}}]{SSP 2.33 (Ed. p. 44): niyama iti manovṛttīnāṃ niyamanam | iti ekāntavāso niḥsaṅgatā audāsīnyaṃ yathāprāptisaṃtuṣṭir vairāgyaṃ gurucaraṇāvarūḍhatvam iti niyamalakṣaṇam |}
...
%----------------------------
\note[type=source, labelb=253, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841): āsanāni ca tāvanti yāvanto jīvajantavaḥ |}
\note[type=source, labelb=254, lem={\textbf{Re}}]{SSP 2.34 (Ed. p. 44): āsanam iti svasvarūpe samāsannatā | svastikāsanaṃ padmāsanaṃ siddhāsanam eteṣāṃ madhye yatheṣṭam ekaṃ vidhāya sāvadhānena sthātavyam ity āsanalakṣaṇam |}
...
%----------------------------
\note[type=source, labelb=255, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841): prāṇāyāmas tridhā ceti bahudhā prathamaṃ śṛṇu | āsane prāṇasaṃyāme na śaktāḥ sukumārakāḥ | mahāpuṇyaprabhāveṇa śakyate tu mahātmanā |}
\note[type=source, labelb=256, lem={\textbf{Re}}]{SSP 2.45 (Ed. p. 45): prāṇāyāma iti prāṇasya sthiratā recakapūrakakumbhakasaṃghaṭṭakaraṇāni catvāri prāṇāyāmalakaṇam |}
%----------------------------
prāṇāyāmas-tu
\app{\lem[wit={E,P}]{sukumāreṇa}
  \rdg[wit={B,L,U2}]{kumāreṇa}
  \rdg[wit={X}]{kūmāreṇa puruṣeṇa}}
sādhituṃ na śakyate/\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{10}]}\end{otherlanguage}}
    \end{prose}
  \end{edition}
  \begin{translation}
    \ekddiv{type=trans}
...
The observances are peace, conquer of the six senses\footnote{The sixth sense is the mental faculty (\textit{manas}, \textit{citta}), cf. \citeauthor[2021:18]{white2021}.}, little food, conquer of sleep, conquer of cold and heat.\footnote{Rāmacandra presents a unique mix of his sources: \textit{Yogasvarodaya} lists peace (\textit{śānti}), contentment (\textit{santoṣa}), little sleep (\textit{nidrālpa}), taming of the mind (\textit{manaso dama}) and emptiness of the inner organ (\textit{śūnyāntaḥkaraṇa}). \citetitle{ssplonavla} lists: tranquility (\textit{upaśama}), conquer of all senses (\textit{sarvendriyajaya}), and conquer of food, sleep, cold, wind, heat (\textit{ahāranidrāśītavātātapajaya})}.\textsuperscript{\coro{[\lowroman{5}]}}
...
The characteristic of posture has been discussed in many works. Because of that, it will not be discussed here.
 ...
 Breath-control can not be practiced by young persons.\textsuperscript{\coro{[\lowroman{10}]}}
\end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
%----------------------------
    \note[type=source, labelb=258, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841) = YK\textsuperscript{qcr \cdot YSV} 7.6-7 (Ed. p. 67): kṛtvā kalevaraṃ śuddhaṃ kuryād yatnair mahātmanā | mano nivārya saṃsāre viṣayeṣu tathaiva ca | manovikārān sarvāś ca tyaktvā śūnyamayo bhavet | pratyāhāro bhavaty eṣu sarvanindācamatkṛtaḥ |}
    \note[type=source, labelb=257, lem={\textbf{Re}}]{SSP 2.36 (Ed. p. 45): pratyāhāra iti caitanyaturaṅgānāṃ pratyāharaṇaṃ vikāragrasanaṃ utpannavikārasyāpi nivṛttir nirbhātīti pratyāhāralakṣaṇām |}
pratyāhāraḥ
\app{\lem[wit={ceteri}]{kathyate}
  \rdg[wit={E}]{pratyato}}/
...
%-----------------------------
 \note[type=source, labelb=260, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841) = YK\textsuperscript{qcr \cdot YSV} 7.8 (Ed. p. 21): dhyānan tu dvividhaṃ proktaṃ sthūlasūkṣmavibhedataḥ | sthūlaṃ mantramayaṃ viddhi sūkṣmantu mantravarjjitam |}
 \note[type=source, labelb=259, lem={\textbf{Re}}]{SSP 2.38 (Ed. p. 46):  atha dhyānam | asti kaścana paramādvaitasya bhāvaḥ | sa evātmeti yathā yadyat sphurati tattatsvarūpam eveti bhāvayet | sarvabhūteṣu samadṛṣṭiś ca | iti dhyānalakṣaṇam |}
...
\app{\lem[wit={ceteri}]{nocyate}
  \rdg[wit={U1}]{na ucyate}}\dd{}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{15}]}\end{otherlanguage}}\end{prose}
\vfill
\nolinenumbers
 \smallskip
 \centerline{\textrm{\small{[\uproman{32}.\textsuperscript{\coro{\lowroman{1}-\lowroman{9}}}Internal and External Universe]}}}
...
%----------------------------
   \note[type=source, labelb=261, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 841): piṇḍabrahmāṇḍayor aikyaṃ śṛṇv idānīṃ prayatnataḥ | brahmāṇḍe santi ye cāṇḍāḥ piṇḍamadhye 'pi te sthitāḥ |}
   \note[type=testium, labelb=262, lem={\textbf{Ri}}]{SSP 3.1 (Ed. p. 28): piṇḍamadhye carācaraṃ yo jānāti sa yogī piṇḍasaṃvittir bhavati|}
...
%----------------------------
\note[type=source, labelb=264, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. pp. 841-42): talaṃ pādāṅguṣṭhatale tasyopari talātalam | mahātalaṃ gulphayor madhye gulphopari rasātalam | sutalaṃ jaṅghayor madhye vitalaṃ jānumadhyakam | ūrvormadhye 'talaṃ proktaṃ saptapātālam īritam | talaṃ talātalañ ceti mahātalarasātalam | saptapātālam etat tu sutalaṃ vitalātalam |}
\note[type=testium, labelb=265, lem={\textbf{Ri}}]{SSP 3.1-2 (Ed. pp. 48-49): kūrmaṅ pādatale vasati | pātālaṃ pādāṅguṣṭhe | talātalam aṅguṣṭhāgre | mahātalaṃ pādapṛṣṭhe | rasātalaṃ gulphe | sutalaṃ jaṅghāyāṃ | vitalaṃ jānvoḥ | atalam ūrvoḥ |}
...
talātalaṃ
\app{\lem[wit={ceteri}]{vartate}
  \rdg[wit={P}]{vartate | pādopari talaṃ vartate}}/\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
\app{\lem[wit={Y},alt={gulphayor}]{gulphayo\skp{r-ma}}
  \rdg[wit={X}]{gulpho}
}\app{\lem[wit={Y},alt={mahātalaṃ}]{\skm{r-m}ahātalaṃ}
  \rdg[wit={X}]{parimahātalaṃ}}
vartate/
\crazy{\app{\lem[type=emendation, resp=egoscrconj]{gulphopari rasātalaṃ vartate}
    \rdg[wit=ceteri]{\om}}}
\note[type=philcomm, labelb=265a, lem={rasātalaṃ}]{Probably lost in transmission, hence I conjectured.}
...
Talam exists at the base of the big toe[s] of the feet. On top of the feet exists Talātala.\textsuperscript{\coro{[\lowroman{5}]}} Mahātala exists at the two ankles. \crazy{Rasātala exists above the ankles.} Sutala exists in the center of the lower part of the leg between ankle and knee. Vitala exists in the middle of the knee. Atala exists in the middle of the two thighs.\footnote{Hindu cosmography, according to various \textit{Purāṇa}s, the \textit{Atharaveda}, etc. assume fourteen worlds (\textit{loka}s), seven higher ones (\textit{vyāhṛti}) and seven lower ones (\textit{pātāla}s). The \ldots}
   \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
 \centerline{\textrm{\small{[\uproman{33}.\textsuperscript{\coro{\lowroman{1}-\lowroman{4}}}Triad of Worlds]}}}
    \bigskip
    \begin{prose}
        \noindent
%----------------------------
...
%----------------------------
\note[type=source, labelb=266, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 842): idānīṃ piṇḍamadhye tu saptalokaṃ śṛṇu priye | mūlādhāre tu bhūrloko liṅgāgre tu bhuvas tataḥ | svarloko liṅgamūle tu merumūle mahas tathā |}
\note[type=testium, labelb=267, lem={\textbf{Ri}}]{SSP 3.3 (Ed. p. 49): bhūrloko guhyasthāne bhuvarloko liṅgasthāne svarlokaṃ nābhisthāne evaṃ lokatraye indro devatā piṇḍamadhye sarvendriyaniyāmakaḥ sa evendraḥ |}
\app{\lem[wit={ceteri}]{idānīṃ}
...
\nolinenumbers
 \bigskip
 \centerline{\textrm{\small{[\uproman{34}.\textsuperscript{\coro{\lowroman{1}-\lowroman{5}}}Tetrad of Worlds]}}}
...
%-----------------------------
%Now the quadruplet of worlds will be taught. The great world (\textit{maharloka}) is at the shoot of the staff of the back. The world of men is in the centre of the cavity of the spine. In the centre of the tube of that spine is the world of \crazy{heat?} (\textit{tapoloka}). In the center of the lotus of the spine is the world of truth. 
%-----------------------------
idānīṃ
...
kathyate/
\note[type=source, labelb=268, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 842): merucchidre janoloko merunāḍyāṃ tapas tathā | kamale marttyalokas tu iti lokaḥ pṛthak pṛthak | bhūrbhuvaḥsvarmahaś ceti janaś caiva tapas tathā | saptamaḥ satyalokas tu saptaloka iti smṛtaḥ | saptalokais tu pātālair bhuvanāni caturdaśa |}
\note[type=testium, labelb=269, lem={\textbf{Ri}}]{SSP 3.4 (Ed. p. 49): daṇḍāṅkure maharlokaḥ daṇḍakuhare janolokaḥ | daṇḍanāle tapolokaḥ | mūlakamale satyalokaḥ |}
...
\vfill
 \centerline{\textrm{\small{[\uproman{34}.\textsuperscript{\coro{\lowroman{1}-\lowroman{5}}}Tetrad of Worlds]}}}
\bigskip
Now the tetrad of worlds is taught. The great world (\textit{maharloka}) is at the shoot of the staff of the back. The world of men (\textit{janaloka}) is in the center of the cavity of the spine. In the center of the tube of that spine is the world of ascetic heat (\textit{tapoloka}). In the center of the lotus of the spine is the world of truth (\textit{satyaloka}).\footnote{For a lengthy presentation of Hindu cosmography and their inhabitants, see \citetitle{bhagavata} 5.16-26 or \citetitle{vayupurana} 5.39.}\textsuperscript{\coro{[\lowroman{5}]}}
    \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
 \centerline{\textrm{\small{[\uproman{35}.\textsuperscript{\coro{\lowroman{1}-\lowroman{4}}}Lords of the Four Worlds]}}}
    \bigskip
    \begin{prose}
      \noindent
%----------------------------
...
\begin{alignment}[
  ...
  \begin{edition}
    ...
    \begin{prose}
      \noindent
\crazy{\app{\lem[wit={D,U1}]{śṛṅgāṭikāyāṃ}
...
\nolinenumbers
 \bigskip
\centerline{\textrm{\small{[\uproman{36}.\textsuperscript{\coro{\lowroman{1}-\lowroman{9}}}Seven Islands]}}}
    \label{sevenislands}
    \bigskip
    \linenumbers
    \begin{prose}
...
%----------------------------
\note[type=source, labelb=275, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 842): sapta dvīpāni kathyante 'dhunā tāni śṛṇu priye  | jambūdvīpas tu majjāyāṃ śākadvīpas tu madhyamaḥ | śālmadvīpaḥ śiromadhye māṃsamadhye kuśas tathā | tvaci krauñco lomamadhye gomayadvīpa īritaḥ | nakhamadhye tathā śvetaḥ saptadvīpā vasundharā | jambūḥ śākas tathā śālmaḥ kuśaḥ krauñcaś ca gomayaḥ | śvetaḥ sapteti khaṇḍāni saptakhaṇḍair vasundharā | guptāny etāni rūpāṇi dehamadhye sthirāṇi ca |}
\note[type=testium, labelb=274, lem={\textbf{Ri}}]{SSP 3.7 (Ed. p. 54): majjāyāṃ jambūdvīpaḥ | asthiṣu śākadvīpaḥ | śirāsu sūkṣmadvīpaḥ | tvakṣu krauñcadvīpaḥ | romasu gomayadvīpaḥ | nakheṣu śvetadvīpaḥ | māṃse plakṣadvīpaḥ | evaṃ saptadvīpāḥ |}
...
%----------------------------
māṃsamadhye kuśadvīpaḥ\dd{}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
...
\crazy{\ldots at the crossroads of the center of the skull, at the center of the lotus pond, at the aperture of Brahman, at the place of the three peaks above the lotuses.} Thus, the 21 worlds reside in 21 locations.
\end{tlate}
\begin{tlate}
  \bigskip
  \centerline{\textrm{\small{[\uproman{36}.\textsuperscript{\coro{\lowroman{1}-\lowroman{9}}}Seven Islands]}}}
...
(1) Within the marrow is the island of Jambu. (2) Within the bones is the island of Śāka. (3) In the head is the island of Śālmali. (4) In the flesh is the island of Kuśa.\textsuperscript{\coro{[\lowroman{5}]}} Within the skin is the island of Krauñca. (6) At the hairy line between the chest and navel (\textit{loma}) is the island of Gomaya. (7) In the nails is the island of Śveta. These hidden islands are situated within. 
\end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
   \centerline{\textrm{\small{[\uproman{37}.\textsuperscript{\coro{\lowroman{1}-\lowroman{9}}}Seven Oceans]}}}
   \bigskip
       \begin{prose}
      \noindent
%----------------------------
...
%----------------------------
      \note[type=source, labelb=276, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. pp. 842-43): samudrāḥ sapta kathyante piṇḍamadhye vyavasthitāḥ | lavaṇekṣusurāsarpirdadhidugdhajalāntakāḥ | lavaṇaṃ svedamadhye tu ikṣūrakte madhu tvaci | sarpir medo vasāmadhye dadhi kṣīraṃ lalāṭake | vīryamadhye 'mṛto jñeyaḥ pāde kūrmaḥ sthito mahān |}
      \note[type=testium, labelb=277, lem={\textbf{Ri}}]{SSP 3.8 (Ed. p. 29): mūrte kṣārasamudraḥ | śukre 'mṛtasamudraḥ | lālāyāṃ kṣīrasamudraḥ | kaphe dadhisamudraḥ | medasi ghṛtasamudraḥ | vasāyāṃ madhusamudraḥ | rakte ikṣusamudraḥ | evaṃ saptasamudrāḥ ||}
idānīṃ piṇḍamadhye
...
\nolinenumbers
% \bigskip
   \centerline{\textrm{\small{[\uproman{38}.\textsuperscript{\coro{\lowroman{1}-\lowroman{2}}}Nine Continents]}}}
    \label{quadrupletofworlds}
    \bigskip
    \linenumbers
    \begin{prose}
...
%----------------------------
\note[type=source, labelb=278, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): idānīn tu navadvāre navakhaṇḍāni saṃśṛṇu | pāyvādau bhārataṃ khaṇḍaṃ kāśmīraṃ trikamaṇḍalum | dvijakhaṇḍam ekapādaṃ khaṇḍaṃ vakṣye samaṇḍalam | kaivarttaṃ garttagāndhāraṃ navakhaṇḍam iti sthitam |}
\note[type=source, labelb=279, lem={\textbf{Re}}]{SSP 3.9 (Ed. p. 55): navakhaṇḍāḥ nava dvāreṣu vasanti| bhāratakhaṇḍaḥ kāśmīrakhaṇḍaḥ karparakhaṇḍaḥ śrīkhaṇḍaḥ śaṅkhakhaṇḍaḥ ekapādakhaṇḍaḥ gāndhārakhaṇḍaḥ kaivartakhaṇḍaḥ mahāmerukhaṇḍaḥ evaṃ navakhaṇḍāḥ|}
...
\end{prose}
  ...
  \begin{translation}
    ...
    \begin{tlate}
      ...
      \bigskip
      \noindent
Now the seven oceans within the body are taught.\footnote{Rāmacandra clearly took the PT\textsuperscript{qcr \cdot YSV} (Ed. pp. 842-43) (cf. \textbf{sources} on previous page) as his template for formulations. The order of oceans has slightly changed. The passage can be translated as follows: \begin{quote} The seven oceans are taught to be situated within the body, [one of each] containing salt (\textit{lavaṇa}), sugar (\textit{ikṣu}), wine (\textit{surā}), butter (\textit{sarpir}), sour milk (\textit{dadhi}), milk (\textit{dugdha}) and water (\textit{jala}). (1) Salt is within sweat, (2) sugar in the blood, (3) wine in the skin, (4) butter in the fat, (5-6) sour milk and milk in the forehead. (7) The nectar of immortality is known to be situated within semen. A big turtle (the earth represented as a tortoise floating on water) is situated at their feet. \end{quote}}

  (1) Within sweat is the salt ocean. (2) Within the forehead is the milk ocean. (3) Within the marrow is the honey-ocean. (4) In the phlegm is the sour milk ocean. (5) In the fat is the butter ocean. (6) Within the blood is the sugarcane ocean. (7) Within the semen is the ocean of the nectar of immortality. Situated at [their] feet is the place of the turtle\footnote{The earth consisting of seven islands with mount meru in it center represented as a tortoise floating on waters of the seven oceans, cf. \citetitle{markandeya} 58, \citetitle{bhagavata} 5.16-26 and \citeauthor[2009:354]{bryant2009}.}.
\end{tlate}
\begin{tlate}
  \bigskip
  \centerline{\textrm{\small{[\uproman{38}.\textsuperscript{\coro{\lowroman{1}-\lowroman{2}}}Nine Continents]}}}
  \bigskip
  Now the nine continents\footnote{The island of Jambudvīpa consists of nine continents.} within the nine doors\footnote{The nine doors (\textit{navadvāra}) refer to the nine openings of the body: mouth, nostrils, eyes, ears, anus and gender.} are taught: Bharata (1), Kaśmīra (2), Strīmaṇḍala (3), Dvija (4), Ekapāda (5), Rākṣasa (6), Ghandhāra (7), Kaivartta (8) [and] Garbha (9).\footnote{There is complete divergence between the two main groups of manuscripts. I edited according to the \alpha-group, since their readings are close to the source texts. The \beta-group rewrote the passage by adding the names of the nine doors which are partially lacking in \citetitle{ramatosana} and missing entirely in the \citetitle{ssplonavla}. The \beta-group assigns the names of an alternative system to the areas. Perhaps a scribe was dissatisfied with the unusual nomenclature. The \beta-group situates (1) the Bharatakhaṇḍa within the mouth, (2-3) the Kinnara- und Harikhaṇḍa in the two nostrils, (4-5) the Ketumāla- and Bhadrāśva[-khaṇḍa] in the eyes, (6-7) the Hiraṇyamaya- and Ramyakakhaṇḍa in the ears, (8) the Kurukhaṇḍa at the Anus, and (9) the Ilāvṛta[-khaṇḍa] at the gender (9). This system along with a lenghty description with many details is presented in \citetitle{parakhya} 5.61-93.}
  \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
    \centerline{\textrm{\small{[\uproman{39}.\textsuperscript{\coro{\lowroman{1}-\lowroman{10}}}Eight Mountains]}}}
    \bigskip
    \begin{prose}
      \noindent
%----------------------------
...
%----------------------------
\note[type=source, labelb=281, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): idānīṃ parvatāś cāṣṭau kathyante śṛṇu yatnataḥ | merudaṇḍe sumerus tu pīṭhamadhye himālayaḥ | vāmaskandhe tathā dakṣe malayo mandarācalaḥ | vindhyas tu dakṣiṇe karṇe vāme maināka īśvari | lalāṭe madhyadeśe tu śrīśailaḥ parameśvari | tathā brahmakapāṭasthaḥ kailāsaḥ parvato mahān | sumerur himavān vindhyo malayo mandaras tathā | śrīśailo mainākaś ceti kailāso 'ṣṭau ca parvatāḥ | apare parvatāḥ sarveaṅgulīmadhyavāsinaḥ |}
\note[type=source, labelb=282, lem={\textbf{Re}}]{SSP 3.10 (Ed. p. 56): meruparvato merudaṇḍe vasati | kailāso brahmakapāṭe vasati | himālayaḥ pṛṣṭhe | malayo vāmakandhare | mandaro dakṣiṇakandhare | vindhyo dakṣiṇakarṇe | mainākaḥ vāmakarṇe | śrīparvato lalāṭe | evam aṣṭa kulaparvatāḥ | anye upaparvatāḥ sarvāṅguliṣu vasanti |}
...
vāmaskaṃdhe malayācalaḥ\dd{}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
...
\app{\lem[wit={ceteri}]{vartante}
  \rdg[wit={B,L}]{vartate}
  \rdg[wit={U1}]{parvate}}/\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{10}]}\end{otherlanguage}}
\end{prose}
\vfill
\nolinenumbers
\bigskip
\centerline{\textrm{\small{[\uproman{40}.\textsuperscript{\coro{\lowroman{1}-\lowroman{4}}}Nine Rivers]}}}
    \label{ninerivers}
    \bigskip
    \linenumbers
    \begin{prose}
...
%----------------------------
      \note[type=source, labelb=284, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843):  śarīre navanāḍīsthā narmadā ca maheśvari | iḍāyāṃ yamunā devi piṅgalāyāṃ sarasvatī | suṣumnāyāṃ vahed gaṅgā cānyonyāsu ca nāḍiṣu | gaṅgā sarasvatī godā narmadā yamunā tathā | kāverī candrabhāgā ca vitastā ca iḍāvatī | dvisaptatisahasreṣu nadīnadaparisravaḥ |}
      \note[type=source, labelb=283, lem={\textbf{Re}}]{SSP 3.11-12 (Ed. p. 57): pīnasā gaṅgā yamunā candrabhāgā sarasvatī | pipāsā śatarudrā ca śrīrātriś caiva narmadā evaṃ nava nadyo navanāḍīṣu vasanti | anyā upanadyaḥ kulyopakulyāḥ dvisaptatisahasranāḍīsu vasanti |}
idānīṃ
...
\note[type=philcomm, labelb=285, lem={śatarudrā}]{I emended according to PT\textsuperscript{qcr \cdot YSV}.}
...
(1) Within the spine is mount Meru. (2) Within the door of Bahman is mount Kailasa. (3) Within the back is the Himālaya. (4) Within the left shoulder mount Malabar.\textsuperscript{\coro{[\lowroman{5}]}} (5) Within the right shoulder the mountain of Mandara. (6) In the right ear the Vindhya mountain. (7) In the left ear the Maināka[-mountain]. (8) Within the forehead Śrīśaila. Other mountains exist in the hands, feet, and toes.\textsuperscript{\coro{[\lowroman{10}]}}
\end{tlate}
\begin{tlate}
  \bigskip
\centerline{\textrm{\small{[\uproman{40}.\textsuperscript{\coro{\lowroman{1}-\lowroman{4}}}Nine Rivers]}}}
  \bigskip
Now within the body there are nine rivers. Within it the courses of the nine rivers exist. Gaṅga, Yamuna, Vitastā, Candrabhāga, Sarasvatī, Vipāśā, Śatarudrā, Irāvati und Narmadā. Other rivers, and waterfalls near the rivers, currents, lakes, ponds and wells are situated within the 72000 channels.
    \end{tlate}
  \end{translation}
\end{alignment}
\ekdpb*{}
...
\begin{alignment}[
  ...
  \begin{edition}
    \ekddiv{type=ed}
    \centerline{\textrm{\small{[\uproman{41}.\textsuperscript{\coro{\lowroman{1}-\lowroman{28}}}Other Contents of the Body]}}}
    \bigskip
    \begin{prose}
      \noindent
%-----------------------------
...
%-----------------------------
\note[type=source, labelb=286, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): itas tato dehamadhye ṛkṣaś ca saptaviṃśatiḥ | yogāś ca rāśayaś caiva grahāś ca tithayas tathā |}
\note[type=source, labelb=287, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 57): saptaviṃśatir nakṣatrāṇi | dvādaśa rāśayaḥ | navagrahāḥ | nava lakṣa tārāḥ | pañcadaśa tithayaḥ | ete 'ntarvalaye dvisaptatisahasra koṣṭheṣu vasanti | anekatārāmaṇḍalam ūrmipuñje vasati |}
...
\app{\lem[wit={P,U1,U2}]{ketuḥ}
  \rdg[wit={E}]{ketavaḥ}
  \rdg[wit={ceteri}]{°ketu}}\dd{}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{5}]}\end{otherlanguage}}
\crazy{
...
%-----------------------------
\note[type=source, labelb=287, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): laharīṣu mīnamanī cāvāhanaṃ sthāpanaṃ tathā | sarvāṅgeṣu ca deveśi samagraṃ ṛkṣamaṇḍalam | trayastriṃśatkoṭay astu nivasanti ca devatāḥ |}
\note[type=source, labelb=288, lem={\textbf{Re}}]{SSP 3.13 (Ed. pp. 57-58): anekatārāmaṇḍalaṃ ūrmipuñje vasanti | trayastriṃśatkoṭidevatā bāhuromakūpeṣu vasanti |}
...
%-----------------------------
\note[type=source, labelb=289, lem={\textbf{Re}}]{Ysv\textsuperscript{PT}: sarvāṅgeṣu ca deveśi samagraṃ ṛkṣamaṇḍalam | trayastriṃśatkoṭay astu nivasanti ca devatāḥ |}
\note[type=source, labelb=290, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 58): trayastriṃśatkoṭidevatā bāhuromakūpeṣu vasanti |}
...
\app{\lem[wit={D,U1}]{dhāvanaṃ bhavati}
  ...
  \rdg[wit={E}]{\om}}/\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{10}]}\end{otherlanguage}}
tanmadhye
...
\end{prose}
  ...
  \begin{translation}
    \ekddiv{type=trans}
    \begin{tlate}
\centerline{\textrm{\small{[\uproman{41}.\textsuperscript{\coro{\lowroman{1}-\lowroman{27}}}Other Contents of the Body]}}}
\bigskip
\noindent
...
Nine Planets: Sun, Moon, Mars, Mercury, Jupiter, Venus, Saturn, the head of the snake demon (ascending node), and the tail of the snake demon (descending node).\textsuperscript{\coro{[\lowroman{5}]}} \crazy{The fifteen lunar days reside there within [the body?].}

Just as the wave resides in the ocean, so does the wave called Ūrmī reside in the body.
Thus, from the fluctuation of Ūrmī, movement arises in the body. [And] flowing arises.\textsuperscript{\coro{[\lowroman{10}]}}
Within it, the entire circle of fixed stars exists.
...
%-----------------------------
\note[type=source, labelb=291, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): tathā pīṭhāni sarvāṇi dehamadhye sthitāni ca |}
\note[type=source, labelb=292, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 58): anekapīṭhopapīṭhakā romakūpeṣu vasanti |}
\note[type=philcomm, labelb=293, lem={\uproman{41}\textsuperscript{\lowroman{13}-\lowroman{14}}}]{Sentences \om in \getsiglum{E}.}
\crazy{
...
%-----------------------------
\note[type=source, labelb=294, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): hṛdaye vyomamadhye tu anantādyāstu vāsukiḥ | udare vyomamadhye tu pare nāgā vasanti hi |}
\note[type=source, labelb=295, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 58): kulanāgā vakṣasi vasanti |} %%%%ACHtung: LAUT LONAVLA nicht in allen Zeugen!
hṛdayaromamadhye
...
\app{\lem[wit={U2}]{śeṣaḥ}
  ...
  \rdg[wit={P}]{śoṣa}
  \rdg[wit={U1}]{°śoṣa}
  \rdg[wit={D}]{śeṣā}}\dd{}\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{15}]}\end{otherlanguage}}
ete
\app{\lem[wit={ceteri}]{nāgā}
  \rdg[wit={E}]{nāga}}
vasanti/
\note[type=philcomm, labelb=296, lem={\uproman{41}\textsuperscript{\lowroman{15}-\lowroman{16}}}]{List and sentence \om in \getsiglum{B} and \getsiglum{L}.}
%-----------------------------
...
%-----------------------------
\note[type=source, labelb=297, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): udare vyomamadhye tu 'pare nāgā vasanti hi | gandharvakinnarāḥ śūrā vidyādharāpsarādayaḥ | anekatīrthavarṇāś ca guhyakāś ca vasanti hi |}
\note[type=source, labelb=298, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 58): gandharvakinnarakiṃpuruṣā apsarasāṃ gaṇā udare vasanti |}
...
%-----------------------------
\note[type=source, labelb=299, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): anantasiddhayo buddhyā prakāśo varttate hṛdi | meghasya maṇḍalaṃ jñeyam aśrupāte tathaiva ca |}
\note[type=source, labelb=300, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 59): anekatīrthāni marmasthāne vasanti | anantasiddhāḥ matiprakaśe vasanti |}
...
\app{\lem[wit={E,P,U2}]{vasati}
  ...
  \rdg[wit={B}]{vasaṃtī}}/\textsuperscript{\begin{otherlanguage}{english}\coro{[\lowroman{20}]}\end{otherlanguage}}
...
%-----------------------------
\note[type=source, labelb=301, lem={\textbf{Re}}]{PT\textsuperscript{qcr \cdot YSV} (Ed. p. 843): candrārkau netrayormadhye jaṅghā lomasu sākṣiṇaḥ | tṛṇagulmādikañcāpi viśvarūpaṃ smaret tataḥ |}
\note[type=source, labelb=302, lem={\textbf{Re}}]{SSP 3.13 (Ed. p. 59): candrasūryau netradvaye vasataḥ | anekavṛkṣalaṭāgulmatṛṇāni jaṅghāromakasthāne vasanti |}
...
\app{\lem[wit={ceteri}]{vasanti}
  ...
  \begin{translation}
    ...
    \begin{tlate}
      \noindent
\crazy{Within the pores of the back, there are 86000 (\textit{ṣaḍaśītisahasra}) heavenly ascetics. Seats [of power] and great seats [of power] reside within the hair surrounding the upper part of the back.}

Within the cavity of the heart: the great Nāga Takṣaka, Karkoṭaka, Śaṃkha, Pulaka, Vāsuki, Ānanta and Śeṣa.\textsuperscript{\coro{[\lowroman{15}]}} These Nāgas reside [there]. \footnote{Notably, none of the known sources contains the names of the snake demons.}
Within the cavity of the belly reside other snakes, [as well as] Gaṇas, Gandharvas, Kinnaras, Apsaras, Vidyādharas, and Guhyakas.
Within the body at the vulnerable place[s] many series of places of pilgrimage are located. Within the falling tears resides the circle of clouds.\textsuperscript{\coro{[\lowroman{20}]}} Within the light exist infinite Siddhas and Buddhas.

The sun and the moom exist within the two eyes.
...
\nolinenumbers
\bigskip
\centerline{\textrm{\small{[\uproman{42}.\textsuperscript{\coro{\lowroman{1}-\lowroman{2}}}Signs of the Rājayogic Body]}}}
...
\app{\lem[wit={ceteri}]{tataḥ}
  \rdg[wit={B,L}]{tat°}}
\note[type=philcomm, labelb=307, lem={tataḥ \ldots kurvanti}]{Sentence \om in \getsiglum{U1}.}
puruṣasya
...
\app{\lem[wit={ceteri}]{kurvanti}
  ...
  \begin{translation}
    ...
    \label{attributesrajabody}
    \bigskip
Now such signs manifest in the body through Rājayoga. These are being described. The eradication of all diseases occurs. And he has a vision of the entire earth. Subsequently, knowledge of the principles arises. 
